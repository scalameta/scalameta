...
package object dialects {
  ...
  implicit val Scala30: Dialect = Scala213
    ...
    .withAllowByNameRepeatedParameters(true).withAllowLazyValAbstractValues(true)
    .withAllowUpperCasePatternVarBinding(true).withAllowDerives(true).withAllowTypeInBlock(true)
  ...
  implicit val Scala3Future: Dialect = Scala3.withAllowUnderscoreAsTypePlaceholder(true)
    ...
    .withAllowDedentedStringLiterals(true)
