  ...
  def impl(annottees: Tree*): Tree = annottees.transformAnnottees(new ImplTransformer {
    override def transformTrait(cdef: ClassDef, mdef: ModuleDef): List[ImplDef] = {
      ...
      val q"..$infrastructure" = q"""
        ...
        // private[meta] def withEnv(env: Environment): Tree // Generated by @branch and @ast only for subclasses of Term and Name
        ...
        // private[meta] def withAttrs(denot: Denotation, typing: Typing): Tree // Generated by @branch and @ast only for subclasses of Name, Term, Term.Param
        private[meta] def inheritAttrs(tree: Tree): Tree
        ...
        protected def privateWithFlags(flags: $Flags): Tree
        protected def privatePrototype: Tree
