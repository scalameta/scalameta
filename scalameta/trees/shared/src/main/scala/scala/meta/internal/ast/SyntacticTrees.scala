...
object Syntactic {
  object Term {
    object Apply {
      def apply(fun: scala.meta.Term, argss: Seq[Seq[scala.meta.Term]]): scala.meta.Term = {
        argss.foldLeft(fun)((curr, args) => scala.meta.Term.Apply(curr, args))
      }

      def apply(fun: scala.meta.Ctor.Call, argss: Seq[Seq[scala.meta.Term]]): scala.meta.Ctor.Call = {
        argss.foldLeft(fun)((curr, args) => scala.meta.Term.Apply(curr, args))
      }

      def unapply(tree: scala.meta.Tree): Option[(scala.meta.Term, Seq[Seq[scala.meta.Term]])] = {
        tree match {
