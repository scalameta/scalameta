...
private[meta] trait Api {
  ...
  @quasiquote[Type.Arg]('t)            implicit class XtensionQuasiquoteType(ctx: StringContext) extends QuasiquoteParsers
  @quasiquote[Type.Param]('tparam)     implicit class XtensionQuasiquoteTypeParam(ctx: StringContext) extends QuasiquoteParsers
  @quasiquote[Case, Pat.Arg]('p)       implicit class XtensionQuasiquoteCaseOrPattern(ctx: StringContext) extends QuasiquoteParsers
