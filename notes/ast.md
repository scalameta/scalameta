...
@new _root_.scala.meta.internal.ast.Metadata.astCompanion() @new _root_.org.scalameta.adt.Metadata.leafCompanion() object If extends scala.AnyRef {
  ...
  def apply(cond: Term, thenp: Term, elsep: Term): If = {
    def internal(cond: Term, thenp: Term, elsep: Term): If = {
      ...
      val node = new TermIfImpl(null, null, null)(_root_.scala.meta.internal.ast.CommonTyperMacros.initParam(cond), _root_.scala.meta.internal.ast.CommonTyperMacros.initParam(thenp), _root_.scala.meta.internal.ast.CommonTyperMacros.initParam(elsep));
  ...
  @new _root_.scala.SerialVersionUID(1L) final private[If] class TermIfImpl extends If {
    ...
    def <init>(@new _root_.scala.transient() privatePrototype: If, privateParent: _root_.scala.meta.Tree, privateOrigin: _root_.scala.meta.internal.ast.Origin)(_cond: Term, _thenp: Term, _elsep: Term) = {
      super.<init>();
      ()
    };
    def cond: Term = {
    ...
    private[meta] def privateCopy(prototype: _root_.scala.meta.Tree = this, parent: _root_.scala.meta.Tree = privateParent, origin: _root_.scala.meta.internal.ast.Origin = privateOrigin): Tree = new TermIfImpl(prototype.asInstanceOf[If], parent, origin)(_root_.scala.meta.internal.ast.CommonTyperMacros.initField(this._cond), _root_.scala.meta.internal.ast.CommonTyperMacros.initField(this._thenp), _root_.scala.meta.internal.ast.CommonTyperMacros.initField(this._elsep));
...
@@<?> @@<?> object If extends scala.AnyRef with Serializable {
  ...
  def apply(cond: scala.meta.Term, thenp: scala.meta.Term, elsep: scala.meta.Term): scala.meta.Term.If = {
    def internal(cond: scala.meta.Term, thenp: scala.meta.Term, elsep: scala.meta.Term): scala.meta.Term.If = {
      ((): Unit);
      (({
        val result$macro$311: Boolean = cond.!=(null);
        if (result$macro$311)
        ...
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(false, (failures$macro$310 @ _)) => org.scalameta.invariants.InvariantFailedException.raise("cond.!=(null)", failures$macro$310, scala.collection.immutable.Map.apply[String, scala.meta.Term](scala.Tuple2.apply[String, scala.meta.Term]("cond", cond)))
      }: Unit): Unit);
      (({
        val result$macro$313: Boolean = thenp.!=(null);
        if (result$macro$313)
          scala.Tuple2.apply[Boolean, collection.immutable.Nil.type](true, scala.collection.immutable.Nil)
        else
        ...
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(true, _) => ()
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(false, (failures$macro$312 @ _)) => org.scalameta.invariants.InvariantFailedException.raise("thenp.!=(null)", failures$macro$312, scala.collection.immutable.Map.apply[String, scala.meta.Term](scala.Tuple2.apply[String, scala.meta.Term]("thenp", thenp)))
      }: Unit): Unit);
      (({
        val result$macro$315: Boolean = elsep.!=(null);
        if (result$macro$315)
          scala.Tuple2.apply[Boolean, collection.immutable.Nil.type](true, scala.collection.immutable.Nil)
        else
        ...
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(true, _) => ()
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(false, (failures$macro$314 @ _)) => org.scalameta.invariants.InvariantFailedException.raise("elsep.!=(null)", failures$macro$314, scala.collection.immutable.Map.apply[String, scala.meta.Term](scala.Tuple2.apply[String, scala.meta.Term]("elsep", elsep)))
      }: Unit): Unit);
      ((): Unit);
      ((): Unit);
      ((): Unit);
      ...
      (node._cond_=(cond.privateCopy(cond, node, cond.privateCopy$default$3).asInstanceOf[scala.meta.Term]): Unit);
      (node._thenp_=(thenp.privateCopy(thenp, node, thenp.privateCopy$default$3).asInstanceOf[scala.meta.Term]): Unit);
      (node._elsep_=(elsep.privateCopy(elsep, node, elsep.privateCopy$default$3).asInstanceOf[scala.meta.Term]): Unit);
      node
    };
    internal(cond, thenp, elsep)
  };
  ...
  @@<?> @@<?> private[meta] object Quasi extends scala.AnyRef with Serializable {
    ...
    def apply(rank: Int, tree: scala.meta.Tree): scala.meta.Term.If.Quasi = {
      def internal(rank: Int, tree: scala.meta.Tree): scala.meta.Term.If.Quasi = {
        ...
        ((): Unit);
        (({
          val result$macro$317: Boolean = tree.!=(null);
          if (result$macro$317)
            scala.Tuple2.apply[Boolean, collection.immutable.Nil.type](true, scala.collection.immutable.Nil)
          else
          ...
          case (_1: Boolean, _2: List[String])(Boolean, List[String])(true, _) => ()
          case (_1: Boolean, _2: List[String])(Boolean, List[String])(false, (failures$macro$316 @ _)) => org.scalameta.invariants.InvariantFailedException.raise("tree.!=(null)", failures$macro$316, scala.collection.immutable.Map.apply[String, scala.meta.Tree](scala.Tuple2.apply[String, scala.meta.Tree]("tree", tree)))
        }: Unit): Unit);
        ((): Unit);
        ((): Unit);
        ...
        ((): Unit);
        (node._tree_=(tree.privateCopy(tree, node, tree.privateCopy$default$3).asInstanceOf[scala.meta.Tree]): Unit);
        node
      };
      internal(rank, tree)
    };
    ...
    @SerialVersionUID(value = 1L) final private[Quasi] class TermIfQuasiImpl extends AnyRef with scala.meta.Term.If.Quasi {
      ...
      def <init>(privatePrototype: scala.meta.Term.If.Quasi, privateParent: scala.meta.Tree, privateOrigin: scala.meta.internal.ast.Origin)(_rank: Int, _tree: scala.meta.Tree): scala.meta.Term.If.Quasi.TermIfQuasiImpl = {
        ...
        (if (this._tree.==(null))
          {
            ...
            this._tree_=({
<artifact> val qual$97: scala.meta.Tree = this.privatePrototype.tree;
<artifact> val x$321: scala.meta.Tree = this.privatePrototype.tree;
<artifact> val x$322: scala.meta.Term.If.Quasi.TermIfQuasiImpl = this;
<artifact> val x$323: scala.meta.internal.ast.Origin = qual$97.privateCopy$default$3;
qual$97.privateCopy(x$321, x$322, x$323)
      ...
      private[meta] def privateCopy(prototype: scala.meta.Tree = this, parent: scala.meta.Tree = TermIfQuasiImpl.this.privateParent, origin: scala.meta.internal.ast.Origin = TermIfQuasiImpl.this.privateOrigin): scala.meta.Tree = new Quasi.this.TermIfQuasiImpl(prototype.asInstanceOf[scala.meta.Term.If.Quasi], parent, origin)((this._rank: Int), (null: scala.meta.Tree));
      ...
      override <synthetic> def privateCopy$default$3: scala.meta.internal.ast.Origin = TermIfQuasiImpl.this.privateOrigin;
        ...
        (if (this._tree.==(null))
          {
            scala.Predef.require(this.privatePrototype.!=(null), "internal error when initializing TermIfQuasiImpl.tree");
            this._tree_=({
<artifact> val qual$98: scala.meta.Tree = this.privatePrototype.tree;
<artifact> val x$324: scala.meta.Tree = this.privatePrototype.tree;
<artifact> val x$325: scala.meta.Term.If.Quasi.TermIfQuasiImpl = this;
<artifact> val x$326: scala.meta.internal.ast.Origin = qual$98.privateCopy$default$3;
qual$98.privateCopy(x$324, x$325, x$326)
}.asInstanceOf[scala.meta.Tree])
          }
        else
          (): Unit);
  ...
  @SerialVersionUID(value = 1L) final private[If] class TermIfImpl extends AnyRef with scala.meta.Term.If {
    ...
    def <init>(privatePrototype: scala.meta.Term.If, privateParent: scala.meta.Tree, privateOrigin: scala.meta.internal.ast.Origin)(_cond: scala.meta.Term, _thenp: scala.meta.Term, _elsep: scala.meta.Term): scala.meta.Term.If.TermIfImpl = {
      ...
      (if (this._cond.==(null))
        {
          ...
          this._cond_=({
<artifact> val qual$99: scala.meta.Term = this.privatePrototype.cond;
<artifact> val x$327: scala.meta.Term = this.privatePrototype.cond;
<artifact> val x$328: scala.meta.Term.If.TermIfImpl = this;
<artifact> val x$329: scala.meta.internal.ast.Origin = qual$99.privateCopy$default$3;
qual$99.privateCopy(x$327, x$328, x$329)
      ...
      (if (this._thenp.==(null))
        {
          ...
          this._thenp_=({
<artifact> val qual$100: scala.meta.Term = this.privatePrototype.thenp;
<artifact> val x$330: scala.meta.Term = this.privatePrototype.thenp;
<artifact> val x$331: scala.meta.Term.If.TermIfImpl = this;
<artifact> val x$332: scala.meta.internal.ast.Origin = qual$100.privateCopy$default$3;
qual$100.privateCopy(x$330, x$331, x$332)
}.asInstanceOf[scala.meta.Term])
        }
      else
        (): Unit);
      ...
      (if (this._elsep.==(null))
        {
          ...
          this._elsep_=({
<artifact> val qual$101: scala.meta.Term = this.privatePrototype.elsep;
<artifact> val x$333: scala.meta.Term = this.privatePrototype.elsep;
<artifact> val x$334: scala.meta.Term.If.TermIfImpl = this;
<artifact> val x$335: scala.meta.internal.ast.Origin = qual$101.privateCopy$default$3;
qual$101.privateCopy(x$333, x$334, x$335)
}.asInstanceOf[scala.meta.Term])
        }
      else
        (): Unit);
    ...
    private[meta] def privateCopy(prototype: scala.meta.Tree = this, parent: scala.meta.Tree = TermIfImpl.this.privateParent, origin: scala.meta.internal.ast.Origin = TermIfImpl.this.privateOrigin): scala.meta.Tree = new If.this.TermIfImpl(prototype.asInstanceOf[scala.meta.Term.If], parent, origin)((null: scala.meta.Term), (null: scala.meta.Term), (null: scala.meta.Term));
    override <synthetic> def privateCopy$default$1: scala.meta.Tree = this;
    override <synthetic> def privateCopy$default$2: scala.meta.Tree = TermIfImpl.this.privateParent;
    override <synthetic> def privateCopy$default$3: scala.meta.internal.ast.Origin = TermIfImpl.this.privateOrigin;
      ...
      (if (this._cond.==(null))
        {
          scala.Predef.require(this.privatePrototype.!=(null), "internal error when initializing TermIfImpl.cond");
          this._cond_=({
<artifact> val qual$102: scala.meta.Term = this.privatePrototype.cond;
<artifact> val x$336: scala.meta.Term = this.privatePrototype.cond;
<artifact> val x$337: scala.meta.Term.If.TermIfImpl = this;
<artifact> val x$338: scala.meta.internal.ast.Origin = qual$102.privateCopy$default$3;
qual$102.privateCopy(x$336, x$337, x$338)
}.asInstanceOf[scala.meta.Term])
        }
      else
        (): Unit);
      (if (this._thenp.==(null))
        {
          scala.Predef.require(this.privatePrototype.!=(null), "internal error when initializing TermIfImpl.thenp");
          this._thenp_=({
<artifact> val qual$103: scala.meta.Term = this.privatePrototype.thenp;
<artifact> val x$339: scala.meta.Term = this.privatePrototype.thenp;
<artifact> val x$340: scala.meta.Term.If.TermIfImpl = this;
<artifact> val x$341: scala.meta.internal.ast.Origin = qual$103.privateCopy$default$3;
qual$103.privateCopy(x$339, x$340, x$341)
}.asInstanceOf[scala.meta.Term])
        }
      else
        (): Unit);
      (if (this._elsep.==(null))
        {
          scala.Predef.require(this.privatePrototype.!=(null), "internal error when initializing TermIfImpl.elsep");
          this._elsep_=({
<artifact> val qual$104: scala.meta.Term = this.privatePrototype.elsep;
<artifact> val x$342: scala.meta.Term = this.privatePrototype.elsep;
<artifact> val x$343: scala.meta.Term.If.TermIfImpl = this;
<artifact> val x$344: scala.meta.internal.ast.Origin = qual$104.privateCopy$default$3;
qual$104.privateCopy(x$342, x$343, x$344)
}.asInstanceOf[scala.meta.Term])
        }
      else
        (): Unit);
