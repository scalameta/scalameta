...
final case class ExistentialType(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.Message[ExistentialType] with scalapb.lenses.Updatable[ExistentialType] {
    @transient
    ...
    def clearTpe: ExistentialType = copy(tpe = None)
    def withTpe(__v: scala.meta.internal.semanticdb3.Type): ExistentialType = copy(tpe = Option(__v))
