...
final case class RepeatedType(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.Message[RepeatedType] with scalapb.lenses.Updatable[RepeatedType] {
    @transient
    ...
    def clearTpe: RepeatedType = copy(tpe = None)
    def withTpe(__v: scala.meta.internal.semanticdb3.Type): RepeatedType = copy(tpe = Option(__v))
