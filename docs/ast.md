...
@new _root_.org.scalameta.ast.internal.astCompanion() @new _root_.org.scalameta.adt.Internal.leafCompanion() object If extends scala.AnyRef {
  ...
  def apply(cond: Term, thenp: Term, elsep: Term, origin: _root_.scala.meta.Origin = null): If = {
  ...
  abstract trait Api extends If {
    ...
    def copy(cond: Term = this.cond, thenp: Term = this.thenp, elsep: Term = this.elsep, origin: _root_.scala.meta.Origin = null): ThisType = If.apply(cond, thenp, elsep, origin);
    override type ThisType = If;
  ...
  final private[If] class Impl extends Api {
    ...
    <paramaccessor> protected var internalOrigin: _root_.scala.meta.Origin = _;
    ...
    def parent: _root_.scala.Option[_root_.scala.meta.Tree] = if (internalParent.$bang$eq(null))
      ...
      _root_.scala.None;
    def origin: _root_.scala.meta.Origin = {
      if (internalOrigin.$eq$eq(null))
        internalOrigin = _root_.scala.meta.Origin.Synthetic(this)
      else
        ();
      internalOrigin
    };
...
@@<?> @@<?> object If extends scala.AnyRef {
  ...
  def apply(cond: scala.meta.internal.ast.Term, thenp: scala.meta.internal.ast.Term, elsep: scala.meta.internal.ast.Term, origin: scala.meta.Origin = null): scala.meta.internal.ast.Term.If = {
    def internal(cond: scala.meta.internal.ast.Term, thenp: scala.meta.internal.ast.Term, elsep: scala.meta.internal.ast.Term, origin: scala.meta.Origin): scala.meta.internal.ast.Term.If = {
      ((): Unit);
      ({
        val result$macro$280: Boolean = cond.!=(null);
        if (result$macro$280)
        ...
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(false, (failures$macro$279 @ _)) => org.scalameta.invariants.InvariantFailedException.raise("cond.!=(null)", failures$macro$279, scala.collection.immutable.Map.apply[String, scala.meta.internal.ast.Term](scala.Tuple2.apply[String, scala.meta.internal.ast.Term]("cond", cond)))
      }: Unit);
      ({
        val result$macro$282: Boolean = thenp.!=(null);
        if (result$macro$282)
          scala.Tuple2.apply[Boolean, scala.collection.immutable.Nil.type](true, immutable.this.Nil)
        else
  ...
  <synthetic> def apply$default$4: scala.meta.Origin = null;
  ...
  abstract trait Api extends AnyRef with scala.meta.internal.ast.Term.If {
    ...
    def copy(cond: scala.meta.internal.ast.Term = this.cond, thenp: scala.meta.internal.ast.Term = this.thenp, elsep: scala.meta.internal.ast.Term = this.elsep, origin: scala.meta.Origin = null): Api.this.ThisType = Term.this.If.apply(cond, thenp, elsep, origin);
    ...
    <synthetic> def copy$default$4: scala.meta.Origin = null;
    override type ThisType = scala.meta.internal.ast.Term.If;
  ...
  final private[If] class Impl extends AnyRef with scala.meta.internal.ast.Term.If.Api {
    ...
    <paramaccessor> private[this] var internalOrigin: scala.meta.Origin = _;
    <accessor> <paramaccessor> protected def internalOrigin: scala.meta.Origin = Impl.this.internalOrigin;
    <accessor> <paramaccessor> protected def internalOrigin_=(x$1: scala.meta.Origin): Unit = Impl.this.internalOrigin = x$1;
    ...
    def parent: Option[scala.meta.Tree] = if (Impl.this.internalParent.!=(null))
      ...
      scala.None;
    def origin: scala.meta.Origin = {
      if (Impl.this.internalOrigin.==(null))
        Impl.this.internalOrigin_=(scala.meta.Origin.Synthetic.apply(this))
      else
        ();
      Impl.this.internalOrigin
    };
      ...
      (if (this._cond.==(null))
        {
          ...
          this._cond_=({
            ...
            <artifact> val x$112: scala.meta.internal.ast.Term = this.internalPrototype.cond;
            <artifact> val x$113: scala.meta.internal.ast.Term.If.Impl = this;
            <artifact> val x$114: scala.collection.immutable.Seq[Any] @scala.reflect.internal.annotations.uncheckedBounds = qual$22.internalCopy$default$3;
            <artifact> val x$115: scala.meta.Origin = qual$22.internalCopy$default$4;
            qual$22.internalCopy(x$112, x$113, x$114, x$115)
          })
        }
      else
        (): Unit);
      ...
      (if (this._thenp.==(null))
        {
          ...
          this._thenp_=({
            ...
            <artifact> val x$116: scala.meta.internal.ast.Term = this.internalPrototype.thenp;
            <artifact> val x$117: scala.meta.internal.ast.Term.If.Impl = this;
            <artifact> val x$118: scala.collection.immutable.Seq[Any] @scala.reflect.internal.annotations.uncheckedBounds = qual$23.internalCopy$default$3;
            <artifact> val x$119: scala.meta.Origin = qual$23.internalCopy$default$4;
            qual$23.internalCopy(x$116, x$117, x$118, x$119)
          })
        }
      else
        (): Unit);
      ...
      (if (this._elsep.==(null))
        {
          ...
          this._elsep_=({
            ...
            <artifact> val x$120: scala.meta.internal.ast.Term = this.internalPrototype.elsep;
            <artifact> val x$121: scala.meta.internal.ast.Term.If.Impl = this;
            <artifact> val x$122: scala.collection.immutable.Seq[Any] @scala.reflect.internal.annotations.uncheckedBounds = qual$24.internalCopy$default$3;
            <artifact> val x$123: scala.meta.Origin = qual$24.internalCopy$default$4;
            qual$24.internalCopy(x$120, x$121, x$122, x$123)
          })
        }
      else
        (): Unit);
  ...
  @@<?> @@<?> private[meta] object Quasi extends scala.AnyRef {
    ...
    def apply(tree: Any, rank: Int, origin: scala.meta.Origin = null): scala.meta.internal.ast.Term.If.Quasi = {
    ...
    <synthetic> def apply$default$3: scala.meta.Origin = null;
    ...
    abstract trait Api extends AnyRef with scala.meta.internal.ast.Term.If.Quasi {
      ...
      def copy(tree: Any = this.tree, rank: Int = this.rank, origin: scala.meta.Origin = null): Api.this.ThisType = If.this.Quasi.apply(tree, rank, origin);
      <synthetic> def copy$default$1: Any = this.tree;
      <synthetic> def copy$default$2: Int = this.rank;
      <synthetic> def copy$default$3: scala.meta.Origin = null;
      override type ThisType = scala.meta.internal.ast.Term.If.Quasi;
