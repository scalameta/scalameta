...
@new _root_.org.scalameta.ast.internal.astCompanion() @new _root_.org.scalameta.adt.Internal.leafCompanion() object If extends scala.AnyRef {
  ...
  abstract trait Api extends If {
    ...
    private[meta] def env: _root_.scala.meta.semantic.Environment;
    ...
    override private[meta] def withAttrs(typingLike: _root_.scala.meta.internal.semantic.TypingLike): If = {
      ...
      if (isUnattributed.unary_$bang)
        throw new UnsupportedOperationException("can only call withAttrs on unattributed trees; if necessary, call .copy() to unattribute and then do .withAttrs(...)".$plus("\n").$plus(this.show[_root_.scala.meta.internal.ui.Attributes]))
      else
        ();
      val typing = typingLike.typing;
      this.privateCopy(flags = this.privateFlags.$amp(_root_.scala.meta.internal.flags.`package`.TYPECHECKED.unary_$tilde), env = _root_.scala.meta.semantic.Environment.Zero, denot = this.privateDenot, typing = typing, expansion = _root_.scala.meta.internal.semantic.Expansion.Identity)
    };
  ...
  @new _root_.scala.SerialVersionUID(1L) final private[If] class Impl extends Api {
    ...
    @new _root_.scala.transient() <paramaccessor> protected var privateTokens: _root_.scala.meta.Tokens = _;
    <paramaccessor> protected val privateEnv: _root_.scala.meta.semantic.Environment = _;
    ...
    def <init>(privateFlags: _root_.scala.meta.internal.flags.`package`.Flags, @new _root_.scala.transient() privatePrototype: If, privateParent: _root_.scala.meta.Tree, @new _root_.scala.transient() privateTokens: _root_.scala.meta.Tokens, privateEnv: _root_.scala.meta.semantic.Environment, privateTyping: _root_.scala.meta.internal.semantic.Typing, privateExpansion: _root_.scala.meta.internal.semantic.Expansion)(_cond: Term, _thenp: Term, _elsep: Term) = {
      super.<init>();
      ()
    };
    ...
    private[meta] def env: _root_.scala.meta.semantic.Environment = if (privateEnv.$bang$eq(null))
      privateEnv
    else
  ...
  @new _root_.org.scalameta.ast.ast() private[meta] class Quasi extends If with _root_.scala.meta.internal.ast.Quasi with Term.Quasi {
    ...
    override protected def privateEnv: _root_.scala.meta.semantic.Environment = null;
    ...
    override def elsep: _root_.scala.Nothing = throw new _root_.scala.`package`.UnsupportedOperationException(if (this.rank.$eq$eq(0))
      ...
      "unsupported splicing position");
    override private[meta] def withEnv(env: _root_.scala.meta.semantic.Environment): _root_.scala.Nothing = throw new _root_.scala.`package`.UnsupportedOperationException(if (this.rank.$eq$eq(0))
      "unsupported unquoting position"
    else
      "unsupported splicing position");
...
@@<?> @@<?> object If extends scala.AnyRef with Serializable {
  ...
  def apply(cond: scala.meta.internal.ast.Term, thenp: scala.meta.internal.ast.Term, elsep: scala.meta.internal.ast.Term): scala.meta.internal.ast.Term.If = {
    def internal(cond: scala.meta.internal.ast.Term, thenp: scala.meta.internal.ast.Term, elsep: scala.meta.internal.ast.Term): scala.meta.internal.ast.Term.If = {
      ...
      (node._cond_=({
        ...
        <artifact> val x$1921: meta.Tokens = cond.privateCopy$default$4;
        <artifact> val x$1922: scala.meta.semantic.Environment = cond.privateCopy$default$5;
      ...
      (node._thenp_=({
        ...
        <artifact> val x$1929: meta.Tokens = thenp.privateCopy$default$4;
        <artifact> val x$1930: scala.meta.semantic.Environment = thenp.privateCopy$default$5;
      ...
      (node._elsep_=({
        ...
        <artifact> val x$1937: meta.Tokens = elsep.privateCopy$default$4;
        <artifact> val x$1938: scala.meta.semantic.Environment = elsep.privateCopy$default$5;
  ...
  abstract trait Api extends AnyRef with scala.meta.internal.ast.Term.If {
    ...
    private[meta] def env: scala.meta.semantic.Environment;
    ...
    def withTokens(tokens: meta.Tokens): scala.meta.internal.ast.Term.If = {
      <artifact> val x$1942: meta.Tokens = tokens;
      ...
      <artifact> val x$1946: scala.meta.semantic.Environment = this.privateCopy$default$5;
    ...
    private[meta] def withEnv(env: scala.meta.semantic.Environment): scala.meta.internal.ast.Term.If = {
      <artifact> val x$1950: Int = this.privateFlags.&(scala.meta.internal.flags.`package`.TYPECHECKED.unary_~);
      <artifact> val x$1951: scala.meta.semantic.Environment = env;
      ...
      <artifact> val x$1957: meta.Tokens = this.privateCopy$default$4;
    ...
    override private[meta] def withAttrs(typingLike: meta.internal.semantic.TypingLike): scala.meta.internal.ast.Term.If = {
      ...
      if (Api.this.isUnattributed.unary_!)
        throw new scala.`package`.UnsupportedOperationException("can only call withAttrs on unattributed trees; if necessary, call .copy() to unattribute and then do .withAttrs(...)\n".+(scala.this.meta.`package`.XtensionShow[scala.meta.internal.ast.Term.If.Api](this).show[scala.meta.internal.ui.Attributes](ui.this.Attributes.attributesTree[scala.meta.internal.ast.Term.If.Api](Attributes.this.Recursion.Deep))))
      else
        ();
      val typing: scala.meta.internal.semantic.Typing = typingLike.typing;
      {
        ...
        <artifact> val x$1959: meta.semantic.Environment.Zero.type = scala.meta.semantic.Environment.Zero;
        ...
        <artifact> val x$1965: meta.Tokens = this.privateCopy$default$4;
    ...
    private[meta] def withExpansion(expansionLike: meta.internal.semantic.ExpansionLike): scala.meta.internal.ast.Term.If = {
      ...
      val expansion: scala.meta.internal.semantic.Expansion = expansionLike.expansion;
      {
        ...
        <artifact> val x$1967: scala.meta.semantic.Environment = this.privateEnv;
        ...
        <artifact> val x$1973: meta.Tokens = this.privateCopy$default$4;
  ...
  @SerialVersionUID(value = 1L) final private[If] class Impl extends AnyRef with scala.meta.internal.ast.Term.If.Api {
    ...
    @transient <paramaccessor> private[this] var privateTokens: meta.Tokens = _;
    <accessor> <paramaccessor> protected def privateTokens: meta.Tokens = Impl.this.privateTokens;
    <accessor> <paramaccessor> protected def privateTokens_=(x$1: meta.Tokens): Unit = Impl.this.privateTokens = x$1;
    <paramaccessor> private[this] val privateEnv: scala.meta.semantic.Environment = _;
    <stable> <accessor> <paramaccessor> protected def privateEnv: scala.meta.semantic.Environment = Impl.this.privateEnv;
    ...
    def <init>(privateFlags: meta.internal.flags.Flags, privatePrototype: scala.meta.internal.ast.Term.If, privateParent: scala.meta.Tree, privateTokens: meta.Tokens, privateEnv: scala.meta.semantic.Environment, privateTyping: scala.meta.internal.semantic.Typing, privateExpansion: scala.meta.internal.semantic.Expansion)(_cond: scala.meta.internal.ast.Term, _thenp: scala.meta.internal.ast.Term, _elsep: scala.meta.internal.ast.Term): scala.meta.internal.ast.Term.If.Impl = {
      Impl.super.<init>();
      ()
    };
    ...
    private[meta] def env: scala.meta.semantic.Environment = if (Impl.this.privateEnv.!=(null))
      ...
      (if (this._cond.==(null))
        {
          ...
          this._cond_=({
            val copyCond$macro$359: scala.meta.internal.ast.Term#ThisType = {
              ...
              <artifact> val x$1977: meta.Tokens = qual$43.privateCopy$default$4;
              <artifact> val x$1978: scala.meta.semantic.Environment = qual$43.privateCopy$default$5;
            ...
            if (meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If](this.privatePrototype).isTypechecked.!=(meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If.Impl](this).isTypechecked))
              meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term#ThisType](copyCond$macro$359).withTypechecked(meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If.Impl](this).isTypechecked)
            else
              copyCond$macro$359
          })
        }
      ...
      (if (this._thenp.==(null))
        {
          ...
          this._thenp_=({
            val copyThenp$macro$360: scala.meta.internal.ast.Term#ThisType = {
              ...
              <artifact> val x$1985: meta.Tokens = qual$44.privateCopy$default$4;
              <artifact> val x$1986: scala.meta.semantic.Environment = qual$44.privateCopy$default$5;
            ...
            if (meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If](this.privatePrototype).isTypechecked.!=(meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If.Impl](this).isTypechecked))
              meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term#ThisType](copyThenp$macro$360).withTypechecked(meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If.Impl](this).isTypechecked)
            else
              copyThenp$macro$360
          })
        }
      ...
      (if (this._elsep.==(null))
        {
          ...
          this._elsep_=({
            val copyElsep$macro$361: scala.meta.internal.ast.Term#ThisType = {
              ...
              <artifact> val x$1993: meta.Tokens = qual$45.privateCopy$default$4;
              <artifact> val x$1994: scala.meta.semantic.Environment = qual$45.privateCopy$default$5;
            ...
            if (meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If](this.privatePrototype).isTypechecked.!=(meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If.Impl](this).isTypechecked))
              meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term#ThisType](copyElsep$macro$361).withTypechecked(meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If.Impl](this).isTypechecked)
            else
              copyElsep$macro$361
          })
        }
    ...
    override <synthetic> def privateCopy$default$4: meta.Tokens = Impl.this.privateTokens;
    override <synthetic> def privateCopy$default$5: scala.meta.semantic.Environment = Impl.this.privateEnv;
      ...
      (if (this._cond.==(null))
        {
          ...
          this._cond_=({
            val copyCond$macro$362: scala.meta.internal.ast.Term#ThisType = {
              ...
              <artifact> val x$2001: meta.Tokens = qual$46.privateCopy$default$4;
              <artifact> val x$2002: scala.meta.semantic.Environment = qual$46.privateCopy$default$5;
            ...
            if (meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If](this.privatePrototype).isTypechecked.!=(meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If.Impl](this).isTypechecked))
              meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term#ThisType](copyCond$macro$362).withTypechecked(meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If.Impl](this).isTypechecked)
            else
              copyCond$macro$362
          })
        }
      ...
      (if (this._thenp.==(null))
        {
          ...
          this._thenp_=({
            val copyThenp$macro$363: scala.meta.internal.ast.Term#ThisType = {
              ...
              <artifact> val x$2009: meta.Tokens = qual$47.privateCopy$default$4;
              <artifact> val x$2010: scala.meta.semantic.Environment = qual$47.privateCopy$default$5;
            ...
            if (meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If](this.privatePrototype).isTypechecked.!=(meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If.Impl](this).isTypechecked))
              meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term#ThisType](copyThenp$macro$363).withTypechecked(meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If.Impl](this).isTypechecked)
            else
              copyThenp$macro$363
          })
        }
      ...
      (if (this._elsep.==(null))
        {
          ...
          this._elsep_=({
            val copyElsep$macro$364: scala.meta.internal.ast.Term#ThisType = {
              ...
              <artifact> val x$2017: meta.Tokens = qual$48.privateCopy$default$4;
              <artifact> val x$2018: scala.meta.semantic.Environment = qual$48.privateCopy$default$5;
            ...
            if (meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If](this.privatePrototype).isTypechecked.!=(meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If.Impl](this).isTypechecked))
              meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term#ThisType](copyElsep$macro$364).withTypechecked(meta.this.Tree.XtensionTypecheckableTree[scala.meta.internal.ast.Term.If.Impl](this).isTypechecked)
            else
              copyElsep$macro$364
          })
        }
  ...
  @@<?> @@<?> private[meta] object Quasi extends scala.AnyRef with Serializable {
    ...
    abstract trait Api extends AnyRef with scala.meta.internal.ast.Term.If.Quasi {
      ...
      override private[meta] def env: Nothing = throw new scala.`package`.UnsupportedOperationException(if (this.rank.==(0))
        ...
        "unsupported splicing position");
      override protected def privateEnv: scala.meta.semantic.Environment = null;
      ...
      override def elsep: Nothing = throw new scala.`package`.UnsupportedOperationException(if (this.rank.==(0))
        ...
        "unsupported splicing position");
      override private[meta] def withEnv(env: scala.meta.semantic.Environment): Nothing = throw new scala.`package`.UnsupportedOperationException(if (this.rank.==(0))
        "unsupported unquoting position"
      else
        "unsupported splicing position");
      ...
      def withTokens(tokens: meta.Tokens): scala.meta.internal.ast.Term.If.Quasi = {
        <artifact> val x$2022: meta.Tokens = tokens;
        ...
        <artifact> val x$2026: scala.meta.semantic.Environment = this.privateCopy$default$5;
    ...
    @SerialVersionUID(value = 1L) final private[Quasi] class Impl extends AnyRef with scala.meta.internal.ast.Term.If.Quasi.Api {
      ...
      def <init>(privateFlags: meta.internal.flags.Flags, privatePrototype: scala.meta.internal.ast.Term.If.Quasi, privateParent: scala.meta.Tree, privateTokens: meta.Tokens)(_rank: Int, _tree: Any): scala.meta.internal.ast.Term.If.Quasi.Impl = {
        Impl.super.<init>();
        ()
      };
      def parent: Option[scala.meta.Tree] = if (Impl.this.privateParent.!=(null))
