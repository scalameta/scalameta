...
@new _root_.scala.meta.internal.ast.Metadata.astCompanion() @new _root_.org.scalameta.adt.Metadata.leafCompanion() object If extends scala.AnyRef {
  ...
  def apply(cond: Term, thenp: Term, elsep: Term): If = {
    def internal(cond: Term, thenp: Term, elsep: Term): If = {
      ...
      val node = new TermIfImpl(_root_.scala.meta.internal.flags.`package`.ZERO, null, null, null, null, null)(_root_.scala.meta.internal.ast.CommonTyperMacros.initParam(cond), _root_.scala.meta.internal.ast.CommonTyperMacros.initParam(thenp), _root_.scala.meta.internal.ast.CommonTyperMacros.initParam(elsep));
  ...
  @new _root_.scala.meta.internal.ast.ast() private[meta] class Quasi extends If with _root_.scala.meta.internal.ast.Quasi with Term.Quasi {
    ...
    def cond: _root_.scala.Nothing = throw new _root_.scala.`package`.UnsupportedOperationException(if (this.rank.$eq$eq(0))
      "unsupported unquoting position"
    else
      "unsupported splicing position");
    def thenp: _root_.scala.Nothing = throw new _root_.scala.`package`.UnsupportedOperationException(if (this.rank.$eq$eq(0))
      "unsupported unquoting position"
    else
      "unsupported splicing position");
    def elsep: _root_.scala.Nothing = throw new _root_.scala.`package`.UnsupportedOperationException(if (this.rank.$eq$eq(0))
      "unsupported unquoting position"
    else
      "unsupported splicing position");
    def name: _root_.scala.Nothing = throw new _root_.scala.`package`.UnsupportedOperationException(if (this.rank.$eq$eq(0))
      "unsupported unquoting position"
    else
      "unsupported splicing position");
    def value: _root_.scala.Nothing = throw new _root_.scala.`package`.UnsupportedOperationException(if (this.rank.$eq$eq(0))
      "unsupported unquoting position"
    else
      "unsupported splicing position");
    def copy(cond: Term = this.cond, thenp: Term = this.thenp, elsep: Term = this.elsep): If = throw new _root_.scala.`package`.UnsupportedOperationException(if (this.rank.$eq$eq(0))
      "unsupported unquoting position"
    else
      "unsupported splicing position")
  };
  ...
  @new _root_.scala.SerialVersionUID(1L) final private[If] class TermIfImpl extends If {
    <paramaccessor> private[meta] val privateFlags: _root_.scala.meta.internal.flags.`package`.Flags = _;
...
@@<?> @@<?> object If extends scala.AnyRef with Serializable {
  ...
  def apply(cond: scala.meta.Term, thenp: scala.meta.Term, elsep: scala.meta.Term): scala.meta.Term.If = {
    def internal(cond: scala.meta.Term, thenp: scala.meta.Term, elsep: scala.meta.Term): scala.meta.Term.If = {
      ...
      (node._cond_=({
<artifact> val x$685: scala.meta.Term = cond;
<artifact> val x$686: scala.meta.Term.If.TermIfImpl = node;
<artifact> val x$687: meta.internal.flags.Flags = cond.privateCopy$default$1;
<artifact> val x$688: scala.meta.tokens.Tokens = cond.privateCopy$default$4;
<artifact> val x$689: scala.meta.internal.semantic.Environment = cond.privateCopy$default$5;
<artifact> val x$690: scala.meta.internal.semantic.Denotation = cond.privateCopy$default$6;
<artifact> val x$691: scala.meta.internal.semantic.Typing = cond.privateCopy$default$7;
cond.privateCopy(x$687, x$685, x$686, x$688, x$689, x$690, x$691)
}.asInstanceOf[scala.meta.Term]): Unit);
      (node._thenp_=({
<artifact> val x$692: scala.meta.Term = thenp;
<artifact> val x$693: scala.meta.Term.If.TermIfImpl = node;
<artifact> val x$694: meta.internal.flags.Flags = thenp.privateCopy$default$1;
<artifact> val x$695: scala.meta.tokens.Tokens = thenp.privateCopy$default$4;
<artifact> val x$696: scala.meta.internal.semantic.Environment = thenp.privateCopy$default$5;
<artifact> val x$697: scala.meta.internal.semantic.Denotation = thenp.privateCopy$default$6;
<artifact> val x$698: scala.meta.internal.semantic.Typing = thenp.privateCopy$default$7;
thenp.privateCopy(x$694, x$692, x$693, x$695, x$696, x$697, x$698)
}.asInstanceOf[scala.meta.Term]): Unit);
      (node._elsep_=({
<artifact> val x$699: scala.meta.Term = elsep;
<artifact> val x$700: scala.meta.Term.If.TermIfImpl = node;
<artifact> val x$701: meta.internal.flags.Flags = elsep.privateCopy$default$1;
<artifact> val x$702: scala.meta.tokens.Tokens = elsep.privateCopy$default$4;
<artifact> val x$703: scala.meta.internal.semantic.Environment = elsep.privateCopy$default$5;
<artifact> val x$704: scala.meta.internal.semantic.Denotation = elsep.privateCopy$default$6;
<artifact> val x$705: scala.meta.internal.semantic.Typing = elsep.privateCopy$default$7;
elsep.privateCopy(x$701, x$699, x$700, x$702, x$703, x$704, x$705)
}.asInstanceOf[scala.meta.Term]): Unit);
      node
    };
    internal(cond, thenp, elsep)
  ...
  @@<?> @@<?> private[meta] object Quasi extends scala.AnyRef with Serializable {
    ...
    @SerialVersionUID(value = 1L) final private[Quasi] class TermIfQuasiImpl extends AnyRef with scala.meta.Term.If.Quasi {
      ...
      def become[T <: scala.meta.internal.ast.Quasi](implicit ev: scala.meta.internal.ast.AstInfo[T]): T = this match {
        case If.this.Quasi.unapply(<unapply-selector>) <unapply> (0, (tree @ _)) => meta.this.Tree.XtensionSyntacticTree[T](ev.quasi(0, tree)).withTokens(this.tokens).asInstanceOf[T]
        case If.this.Quasi.unapply(<unapply-selector>) <unapply> (1, (nested @ If.this.Quasi.unapply(<unapply-selector>) <unapply> (0, (tree @ _)))) => meta.this.Tree.XtensionSyntacticTree[T](ev.quasi(1, nested.become[T](ev))).withTokens(this.tokens).asInstanceOf[T]
      ...
      (if (this._cond.==(null))
        {
          ...
          this._cond_=({
            val copyCond$macro$195: scala.meta.Term = {
<artifact> val qual$43: scala.meta.Term = this.privatePrototype.cond;
<artifact> val x$706: scala.meta.Term = this.privatePrototype.cond;
<artifact> val x$707: scala.meta.Term.If.TermIfImpl = this;
<artifact> val x$708: meta.internal.flags.Flags = qual$43.privateCopy$default$1;
<artifact> val x$709: scala.meta.tokens.Tokens = qual$43.privateCopy$default$4;
<artifact> val x$710: scala.meta.internal.semantic.Environment = qual$43.privateCopy$default$5;
<artifact> val x$711: scala.meta.internal.semantic.Denotation = qual$43.privateCopy$default$6;
<artifact> val x$712: scala.meta.internal.semantic.Typing = qual$43.privateCopy$default$7;
qual$43.privateCopy(x$708, x$706, x$707, x$709, x$710, x$711, x$712)
            ...
            if (meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If](this.privatePrototype).isTypechecked.!=(meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If.TermIfImpl](this).isTypechecked))
              meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term](copyCond$macro$195).withTypechecked(meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If.TermIfImpl](this).isTypechecked)
            else
              copyCond$macro$195
          })
        }
      ...
      (if (this._thenp.==(null))
        {
          ...
          this._thenp_=({
            val copyThenp$macro$196: scala.meta.Term = {
<artifact> val qual$44: scala.meta.Term = this.privatePrototype.thenp;
<artifact> val x$713: scala.meta.Term = this.privatePrototype.thenp;
<artifact> val x$714: scala.meta.Term.If.TermIfImpl = this;
<artifact> val x$715: meta.internal.flags.Flags = qual$44.privateCopy$default$1;
<artifact> val x$716: scala.meta.tokens.Tokens = qual$44.privateCopy$default$4;
<artifact> val x$717: scala.meta.internal.semantic.Environment = qual$44.privateCopy$default$5;
<artifact> val x$718: scala.meta.internal.semantic.Denotation = qual$44.privateCopy$default$6;
<artifact> val x$719: scala.meta.internal.semantic.Typing = qual$44.privateCopy$default$7;
qual$44.privateCopy(x$715, x$713, x$714, x$716, x$717, x$718, x$719)
}.asInstanceOf[scala.meta.Term];
            if (meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If](this.privatePrototype).isTypechecked.!=(meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If.TermIfImpl](this).isTypechecked))
              meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term](copyThenp$macro$196).withTypechecked(meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If.TermIfImpl](this).isTypechecked)
            else
              copyThenp$macro$196
          })
        }
      ...
      (if (this._elsep.==(null))
        {
          ...
          this._elsep_=({
            val copyElsep$macro$197: scala.meta.Term = {
<artifact> val qual$45: scala.meta.Term = this.privatePrototype.elsep;
<artifact> val x$720: scala.meta.Term = this.privatePrototype.elsep;
<artifact> val x$721: scala.meta.Term.If.TermIfImpl = this;
<artifact> val x$722: meta.internal.flags.Flags = qual$45.privateCopy$default$1;
<artifact> val x$723: scala.meta.tokens.Tokens = qual$45.privateCopy$default$4;
<artifact> val x$724: scala.meta.internal.semantic.Environment = qual$45.privateCopy$default$5;
<artifact> val x$725: scala.meta.internal.semantic.Denotation = qual$45.privateCopy$default$6;
<artifact> val x$726: scala.meta.internal.semantic.Typing = qual$45.privateCopy$default$7;
qual$45.privateCopy(x$722, x$720, x$721, x$723, x$724, x$725, x$726)
}.asInstanceOf[scala.meta.Term];
            if (meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If](this.privatePrototype).isTypechecked.!=(meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If.TermIfImpl](this).isTypechecked))
              meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term](copyElsep$macro$197).withTypechecked(meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If.TermIfImpl](this).isTypechecked)
            else
              copyElsep$macro$197
          })
        }
    ...
    def copy(cond: scala.meta.Term = this.cond, thenp: scala.meta.Term = this.thenp, elsep: scala.meta.Term = this.elsep): scala.meta.Term.If = meta.this.Tree.XtensionSyntacticTree[scala.meta.Term.If](Term.this.If.apply(cond, thenp, elsep)).withTokens(scala.meta.internal.tokens.TransformedTokens.apply(this));
    override <synthetic> def copy$default$1: scala.meta.Term = this.cond;
    override <synthetic> def copy$default$2: scala.meta.Term = this.thenp;
    override <synthetic> def copy$default$3: scala.meta.Term = this.elsep;
      ...
      (if (this._cond.==(null))
        {
          scala.Predef.require(this.privatePrototype.!=(null), "internal error when initializing TermIfImpl.cond");
          this._cond_=({
            val copyCond$macro$198: scala.meta.Term = {
<artifact> val qual$46: scala.meta.Term = this.privatePrototype.cond;
<artifact> val x$727: scala.meta.Term = this.privatePrototype.cond;
<artifact> val x$728: scala.meta.Term.If.TermIfImpl = this;
<artifact> val x$729: meta.internal.flags.Flags = qual$46.privateCopy$default$1;
<artifact> val x$730: scala.meta.tokens.Tokens = qual$46.privateCopy$default$4;
<artifact> val x$731: scala.meta.internal.semantic.Environment = qual$46.privateCopy$default$5;
<artifact> val x$732: scala.meta.internal.semantic.Denotation = qual$46.privateCopy$default$6;
<artifact> val x$733: scala.meta.internal.semantic.Typing = qual$46.privateCopy$default$7;
qual$46.privateCopy(x$729, x$727, x$728, x$730, x$731, x$732, x$733)
}.asInstanceOf[scala.meta.Term];
            if (meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If](this.privatePrototype).isTypechecked.!=(meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If.TermIfImpl](this).isTypechecked))
              meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term](copyCond$macro$198).withTypechecked(meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If.TermIfImpl](this).isTypechecked)
            else
              copyCond$macro$198
          })
        }
      ...
      (if (this._thenp.==(null))
        {
          scala.Predef.require(this.privatePrototype.!=(null), "internal error when initializing TermIfImpl.thenp");
          this._thenp_=({
            val copyThenp$macro$199: scala.meta.Term = {
<artifact> val qual$47: scala.meta.Term = this.privatePrototype.thenp;
<artifact> val x$734: scala.meta.Term = this.privatePrototype.thenp;
<artifact> val x$735: scala.meta.Term.If.TermIfImpl = this;
<artifact> val x$736: meta.internal.flags.Flags = qual$47.privateCopy$default$1;
<artifact> val x$737: scala.meta.tokens.Tokens = qual$47.privateCopy$default$4;
<artifact> val x$738: scala.meta.internal.semantic.Environment = qual$47.privateCopy$default$5;
<artifact> val x$739: scala.meta.internal.semantic.Denotation = qual$47.privateCopy$default$6;
<artifact> val x$740: scala.meta.internal.semantic.Typing = qual$47.privateCopy$default$7;
qual$47.privateCopy(x$736, x$734, x$735, x$737, x$738, x$739, x$740)
}.asInstanceOf[scala.meta.Term];
            if (meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If](this.privatePrototype).isTypechecked.!=(meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If.TermIfImpl](this).isTypechecked))
              meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term](copyThenp$macro$199).withTypechecked(meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If.TermIfImpl](this).isTypechecked)
            else
              copyThenp$macro$199
          })
        }
      ...
      (if (this._elsep.==(null))
        {
          scala.Predef.require(this.privatePrototype.!=(null), "internal error when initializing TermIfImpl.elsep");
          this._elsep_=({
            val copyElsep$macro$200: scala.meta.Term = {
<artifact> val qual$48: scala.meta.Term = this.privatePrototype.elsep;
<artifact> val x$741: scala.meta.Term = this.privatePrototype.elsep;
<artifact> val x$742: scala.meta.Term.If.TermIfImpl = this;
<artifact> val x$743: meta.internal.flags.Flags = qual$48.privateCopy$default$1;
<artifact> val x$744: scala.meta.tokens.Tokens = qual$48.privateCopy$default$4;
<artifact> val x$745: scala.meta.internal.semantic.Environment = qual$48.privateCopy$default$5;
<artifact> val x$746: scala.meta.internal.semantic.Denotation = qual$48.privateCopy$default$6;
<artifact> val x$747: scala.meta.internal.semantic.Typing = qual$48.privateCopy$default$7;
qual$48.privateCopy(x$743, x$741, x$742, x$744, x$745, x$746, x$747)
}.asInstanceOf[scala.meta.Term];
            if (meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If](this.privatePrototype).isTypechecked.!=(meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If.TermIfImpl](this).isTypechecked))
              meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term](copyElsep$macro$200).withTypechecked(meta.this.Tree.XtensionTypecheckableTree[scala.meta.Term.If.TermIfImpl](this).isTypechecked)
            else
              copyElsep$macro$200
          })
        }
