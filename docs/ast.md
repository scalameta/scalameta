...
@new _root_.org.scalameta.ast.internal.astCompanion() @new _root_.org.scalameta.adt.Internal.leafCompanion() object If extends scala.AnyRef {
  ...
  abstract trait Api extends If {
    ...
    def withEnv(env: _root_.scala.meta.semantic.Environment): If = {
      <empty>;
      this.internalCopy(env = env, flags = this.internalFlags.$amp(_root_.scala.meta.internal.flags.`package`.TYPECHECKED.unary_$tilde))
    };
    def withTyping(typing: _root_.scala.meta.internal.semantic.Typing): If = {
      <empty>;
      this.internalCopy(typing = typing, flags = this.internalFlags.$amp(_root_.scala.meta.internal.flags.`package`.TYPECHECKED.unary_$tilde))
    };
    def withExpansion(expansion: _root_.scala.meta.internal.semantic.Expansion): If = {
      <empty>;
      this.internalCopy(expansion = expansion, flags = this.internalFlags.$amp(_root_.scala.meta.internal.flags.`package`.TYPECHECKED.unary_$tilde))
    };
    override type ThisType = If;
    ...
    def withEnv(env: scala.meta.semantic.Environment): scala.meta.internal.ast.Term.If = {
      {
        ...
        <artifact> val x$1944: scala.meta.Tree = this.internalCopy$default$2;
        <artifact> val x$1945: scala.meta.Tree = this.internalCopy$default$3;
        <artifact> val x$1946: meta.Tokens = this.internalCopy$default$4;
        <artifact> val x$1947: scala.meta.internal.semantic.Denotation = this.internalCopy$default$6;
        <artifact> val x$1948: scala.meta.internal.semantic.Typing = this.internalCopy$default$7;
        <artifact> val x$1949: scala.meta.internal.semantic.Expansion = this.internalCopy$default$8;
        this.internalCopy(x$1943, x$1944, x$1945, x$1946, x$1942, x$1947, x$1948, x$1949)
      }
    };
    def withTyping(typing: scala.meta.internal.semantic.Typing): scala.meta.internal.ast.Term.If = {
      {
        ...
        <artifact> val x$1952: scala.meta.Tree = this.internalCopy$default$2;
        <artifact> val x$1953: scala.meta.Tree = this.internalCopy$default$3;
        <artifact> val x$1954: meta.Tokens = this.internalCopy$default$4;
        <artifact> val x$1955: scala.meta.semantic.Environment = this.internalCopy$default$5;
        ...
        this.internalCopy(x$1951, x$1952, x$1953, x$1954, x$1955, x$1956, x$1950, x$1957)
      }
    };
    def withExpansion(expansion: scala.meta.internal.semantic.Expansion): scala.meta.internal.ast.Term.If = {
      {
        ...
        <artifact> val x$1960: scala.meta.Tree = this.internalCopy$default$2;
        <artifact> val x$1961: scala.meta.Tree = this.internalCopy$default$3;
        <artifact> val x$1962: meta.Tokens = this.internalCopy$default$4;
        <artifact> val x$1963: scala.meta.semantic.Environment = this.internalCopy$default$5;
        ...
        this.internalCopy(x$1959, x$1960, x$1961, x$1962, x$1963, x$1964, x$1965, x$1958)
      }
    };
    override type ThisType = scala.meta.internal.ast.Term.If;
