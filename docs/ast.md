...
@@<?> @@<?> object If extends scala.AnyRef with Serializable {
  ...
  def apply(cond: scala.meta.internal.ast.Term, thenp: scala.meta.internal.ast.Term, elsep: scala.meta.internal.ast.Term, @org.scalameta.ast.internal.auxiliary typing: scala.meta.internal.semantic.Typing = scala.meta.internal.semantic.Typing.Unknown, @org.scalameta.ast.internal.auxiliary expansion: scala.meta.internal.semantic.Expansion = scala.meta.internal.semantic.Expansion.Identity, tokens: meta.Tokens = null): scala.meta.internal.ast.Term.If = {
    def internal(cond: scala.meta.internal.ast.Term, thenp: scala.meta.internal.ast.Term, elsep: scala.meta.internal.ast.Term, @org.scalameta.ast.internal.auxiliary typing: scala.meta.internal.semantic.Typing, @org.scalameta.ast.internal.auxiliary expansion: scala.meta.internal.semantic.Expansion, tokens: meta.Tokens): scala.meta.internal.ast.Term.If = {
      ((): Unit);
      ({
        val result$macro$336: Boolean = cond.!=(null);
        if (result$macro$336)
        ...
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(false, (failures$macro$335 @ _)) => org.scalameta.invariants.InvariantFailedException.raise("cond.!=(null)", failures$macro$335, scala.collection.immutable.Map.apply[String, scala.meta.internal.ast.Term](scala.Tuple2.apply[String, scala.meta.internal.ast.Term]("cond", cond)))
      }: Unit);
      ({
        val result$macro$338: Boolean = thenp.!=(null);
        if (result$macro$338)
          scala.Tuple2.apply[Boolean, collection.immutable.Nil.type](true, scala.collection.immutable.Nil)
        else
      ...
      ({
        ...
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(true, _) => ()
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(false, (failures$macro$339 @ _)) => org.scalameta.invariants.InvariantFailedException.raise("elsep.!=(null)", failures$macro$339, scala.collection.immutable.Map.apply[String, scala.meta.internal.ast.Term](scala.Tuple2.apply[String, scala.meta.internal.ast.Term]("elsep", elsep)))
      }: Unit);
      ({
        val result$macro$342: Boolean = typing.!=(null);
        if (result$macro$342)
          scala.Tuple2.apply[Boolean, collection.immutable.Nil.type](true, scala.collection.immutable.Nil)
        else
        ...
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(true, _) => ()
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(false, (failures$macro$341 @ _)) => org.scalameta.invariants.InvariantFailedException.raise("typing.!=(null)", failures$macro$341, scala.collection.immutable.Map.apply[String, scala.meta.internal.semantic.Typing](scala.Tuple2.apply[String, scala.meta.internal.semantic.Typing]("typing", typing)))
      }: Unit);
      ({
        val result$macro$344: Boolean = expansion.!=(null);
        if (result$macro$344)
          scala.Tuple2.apply[Boolean, collection.immutable.Nil.type](true, scala.collection.immutable.Nil)
        else
  ...
  @@<?> @@<?> private[meta] object Quasi extends scala.AnyRef with Serializable {
    ...
    def apply(rank: Int, tree: Any, tokens: meta.Tokens = null): scala.meta.internal.ast.Term.If.Quasi = {
      def internal(rank: Int, tree: Any, tokens: meta.Tokens): scala.meta.internal.ast.Term.If.Quasi = {
        ((): Unit);
        ();
        ();
        ();
        ();
        val node: scala.meta.internal.ast.Term.If.Quasi.Impl = new Quasi.this.Impl(null, null, tokens)((rank: Int), (tree: Any));
        ((): Unit);
        ((): Unit);
        node
      };
      internal(rank, tree, tokens)
    };
    ...
    abstract trait Api extends AnyRef with scala.meta.internal.ast.Term.If.Quasi {
      ...
      def copy(rank: Int = this.rank, tree: Any = this.tree, tokens: meta.Tokens = scala.meta.internal.ui.PrototypeTokens.apply(this)): Api.this.ThisType = If.this.Quasi.apply(rank, tree, tokens);
    ...
    final private[Quasi] class Impl extends AnyRef with scala.meta.internal.ast.Term.If.Quasi.Api {
      ...
      private[meta] def internalCopy(prototype: scala.meta.Tree = this, parent: scala.meta.Tree = Impl.this.internalParent, tokens: meta.Tokens = Impl.this.internalTokens): Impl.this.ThisType = new Quasi.this.Impl(prototype.asInstanceOf[Impl.this.ThisType], parent, tokens)((this._rank: Int), (this._tree: Any));
      override <synthetic> def internalCopy$default$1: scala.meta.Tree = this;
      override <synthetic> def internalCopy$default$2: scala.meta.Tree = Impl.this.internalParent;
      override <synthetic> def internalCopy$default$3: meta.Tokens = Impl.this.internalTokens;
      def parent: Option[scala.meta.Tree] = if (Impl.this.internalParent.!=(null))
