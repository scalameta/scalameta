...
@new _root_.org.scalameta.ast.internal.astCompanion() @new _root_.org.scalameta.adt.Internal.leafCompanion() object If extends scala.AnyRef {
  ...
  abstract trait Api extends If {
    ...
    def copy(cond: Term = this.cond, thenp: Term = this.thenp, elsep: Term = this.elsep): If = If.apply(cond, thenp, elsep).withTokens(tokens = _root_.scala.meta.internal.syntactic.TransformedTokens(this));
    protected def privateWithFlags(flags: _root_.scala.meta.internal.flags.`package`.Flags): If = {
      {
        if (flags.$amp(_root_.scala.meta.internal.flags.`package`.TYPECHECKED).$eq$eq(_root_.scala.meta.internal.flags.`package`.TYPECHECKED).$amp$amp(this.expansion.$eq$eq(_root_.scala.meta.internal.semantic.Expansion.Zero)))
          throw new _root_.scala.`package`.UnsupportedOperationException("failed to enable TYPECHECKED for ".$plus(_root_.scala.meta.internal.ui.Attributes.attributesTree[_root_.scala.meta.Tree].apply(this).toString))
        else
          ();
    ...
    def withTokens(tokens: _root_.scala.meta.syntactic.Tokens): If = this.privateCopy(tokens = tokens);
  ...
  @new _root_.scala.SerialVersionUID(1L) final private[If] class Impl extends Api {
    ...
    @new _root_.scala.transient() <paramaccessor> protected var privateTokens: _root_.scala.meta.syntactic.Tokens = _;
    ...
    def <init>(privateFlags: _root_.scala.meta.internal.flags.`package`.Flags, @new _root_.scala.transient() privatePrototype: If, privateParent: _root_.scala.meta.Tree, @new _root_.scala.transient() privateTokens: _root_.scala.meta.syntactic.Tokens, privateEnv: _root_.scala.meta.internal.semantic.Environment, privateTyping: _root_.scala.meta.internal.semantic.Typing, privateExpansion: _root_.scala.meta.internal.semantic.Expansion)(_cond: Term, _thenp: Term, _elsep: Term) = {
      super.<init>();
      ()
    };
    ...
    def tokens: _root_.scala.meta.syntactic.Tokens = {
      privateTokens = privateTokens match {
        ...
        case _root_.scala.meta.internal.syntactic.TransformedTokens((proto @ _)) => _root_.scala.meta.internal.ui.inferTokens(this, Some(proto))
        case (other @ _) => other
      };
      privateTokens
    };
...
@@<?> @@<?> object If extends scala.AnyRef with Serializable {
  ...
  def apply(cond: scala.meta.internal.ast.Term, thenp: scala.meta.internal.ast.Term, elsep: scala.meta.internal.ast.Term): scala.meta.internal.ast.Term.If = {
    def internal(cond: scala.meta.internal.ast.Term, thenp: scala.meta.internal.ast.Term, elsep: scala.meta.internal.ast.Term): scala.meta.internal.ast.Term.If = {
      ...
      (node._cond_=({
        ...
        <artifact> val x$1921: scala.meta.syntactic.Tokens = cond.privateCopy$default$4;
      ...
      (node._thenp_=({
        ...
        <artifact> val x$1929: scala.meta.syntactic.Tokens = thenp.privateCopy$default$4;
      ...
      (node._elsep_=({
        ...
        <artifact> val x$1937: scala.meta.syntactic.Tokens = elsep.privateCopy$default$4;
  ...
  abstract trait Api extends AnyRef with scala.meta.internal.ast.Term.If {
    ...
    def tokens: scala.meta.syntactic.Tokens;
    ...
    def copy(cond: scala.meta.internal.ast.Term = this.cond, thenp: scala.meta.internal.ast.Term = this.thenp, elsep: scala.meta.internal.ast.Term = this.elsep): scala.meta.internal.ast.Term.If = Term.this.If.apply(cond, thenp, elsep).withTokens(scala.meta.internal.syntactic.TransformedTokens.apply(this));
    ...
    protected def privateWithFlags(flags: meta.internal.flags.Flags): scala.meta.internal.ast.Term.If = {
      {
        if (flags.&(scala.meta.internal.flags.`package`.TYPECHECKED).==(scala.meta.internal.flags.`package`.TYPECHECKED).&&(this.expansion.==(scala.meta.internal.semantic.Expansion.Zero)))
          throw new scala.`package`.UnsupportedOperationException("failed to enable TYPECHECKED for ".+(scala.meta.internal.ui.Attributes.attributesTree[scala.meta.Tree](Attributes.this.Recursion.Deep).apply(this).toString()))
        else
          ();
    ...
    def withTokens(tokens: scala.meta.syntactic.Tokens): scala.meta.internal.ast.Term.If = {
      <artifact> val x$1942: scala.meta.syntactic.Tokens = tokens;
    ...
    private[meta] def withEnv(env: scala.meta.internal.semantic.Environment): scala.meta.internal.ast.Term.If = {
      ...
      <artifact> val x$1957: scala.meta.syntactic.Tokens = this.privateCopy$default$4;
    ...
    override private[meta] def withAttrs(typingLike: meta.internal.semantic.TypingLike): scala.meta.internal.ast.Term.If = {
      ...
      val typing: scala.meta.internal.semantic.Typing = typingLike.typing;
      {
        ...
        <artifact> val x$1965: scala.meta.syntactic.Tokens = this.privateCopy$default$4;
    ...
    private[meta] def withExpansion(expansionLike: meta.internal.semantic.ExpansionLike): scala.meta.internal.ast.Term.If = {
      ...
      val expansion: scala.meta.internal.semantic.Expansion = expansionLike.expansion;
      {
        ...
        <artifact> val x$1973: scala.meta.syntactic.Tokens = this.privateCopy$default$4;
  ...
  @SerialVersionUID(value = 1L) final private[If] class Impl extends AnyRef with scala.meta.internal.ast.Term.If.Api {
    ...
    @transient <paramaccessor> private[this] var privateTokens: scala.meta.syntactic.Tokens = _;
    <accessor> <paramaccessor> protected def privateTokens: scala.meta.syntactic.Tokens = Impl.this.privateTokens;
    <accessor> <paramaccessor> protected def privateTokens_=(x$1: scala.meta.syntactic.Tokens): Unit = Impl.this.privateTokens = x$1;
    ...
    def <init>(privateFlags: meta.internal.flags.Flags, privatePrototype: scala.meta.internal.ast.Term.If, privateParent: scala.meta.Tree, privateTokens: scala.meta.syntactic.Tokens, privateEnv: scala.meta.internal.semantic.Environment, privateTyping: scala.meta.internal.semantic.Typing, privateExpansion: scala.meta.internal.semantic.Expansion)(_cond: scala.meta.internal.ast.Term, _thenp: scala.meta.internal.ast.Term, _elsep: scala.meta.internal.ast.Term): scala.meta.internal.ast.Term.If.Impl = {
      Impl.super.<init>();
      ()
    };
    ...
    def tokens: scala.meta.syntactic.Tokens = {
      Impl.this.privateTokens_=(Impl.this.privateTokens match {
        ...
        case (prototype: scala.meta.Tree)scala.meta.internal.syntactic.TransformedTokens((proto @ _)) => scala.meta.internal.ui.inferTokens.apply(this, scala.Some.apply[scala.meta.Tree](proto))
        case (other @ _) => other
      });
      ...
      (if (this._cond.==(null))
        {
          ...
          this._cond_=({
            val copyCond$macro$183: scala.meta.internal.ast.Term#ThisType = {
              ...
              <artifact> val x$1977: scala.meta.syntactic.Tokens = qual$43.privateCopy$default$4;
      ...
      (if (this._thenp.==(null))
        {
          ...
          this._thenp_=({
            val copyThenp$macro$184: scala.meta.internal.ast.Term#ThisType = {
              ...
              <artifact> val x$1985: scala.meta.syntactic.Tokens = qual$44.privateCopy$default$4;
      ...
      (if (this._elsep.==(null))
        {
          ...
          this._elsep_=({
            val copyElsep$macro$185: scala.meta.internal.ast.Term#ThisType = {
              ...
              <artifact> val x$1993: scala.meta.syntactic.Tokens = qual$45.privateCopy$default$4;
    ...
    override <synthetic> def privateCopy$default$4: scala.meta.syntactic.Tokens = Impl.this.privateTokens;
      ...
      (if (this._cond.==(null))
        {
          ...
          this._cond_=({
            val copyCond$macro$186: scala.meta.internal.ast.Term#ThisType = {
              ...
              <artifact> val x$2001: scala.meta.syntactic.Tokens = qual$46.privateCopy$default$4;
      ...
      (if (this._thenp.==(null))
        {
          ...
          this._thenp_=({
            val copyThenp$macro$187: scala.meta.internal.ast.Term#ThisType = {
              ...
              <artifact> val x$2009: scala.meta.syntactic.Tokens = qual$47.privateCopy$default$4;
      ...
      (if (this._elsep.==(null))
        {
          ...
          this._elsep_=({
            val copyElsep$macro$188: scala.meta.internal.ast.Term#ThisType = {
              ...
              <artifact> val x$2017: scala.meta.syntactic.Tokens = qual$48.privateCopy$default$4;
  ...
  @@<?> @@<?> private[meta] object Quasi extends scala.AnyRef with Serializable {
    ...
    abstract trait Api extends AnyRef with scala.meta.internal.ast.Term.If.Quasi {
      ...
      def tokens: scala.meta.syntactic.Tokens;
      def copy(rank: Int = this.rank, tree: Any = this.tree): scala.meta.internal.ast.Term.If.Quasi = If.this.Quasi.apply(rank, tree).withTokens(scala.meta.internal.syntactic.TransformedTokens.apply(this));
      ...
      def withTokens(tokens: scala.meta.syntactic.Tokens): scala.meta.internal.ast.Term.If.Quasi = {
        <artifact> val x$2022: scala.meta.syntactic.Tokens = tokens;
    ...
    @SerialVersionUID(value = 1L) final private[Quasi] class Impl extends AnyRef with scala.meta.internal.ast.Term.If.Quasi.Api {
      ...
      def <init>(privateFlags: meta.internal.flags.Flags, privatePrototype: scala.meta.internal.ast.Term.If.Quasi, privateParent: scala.meta.Tree, privateTokens: scala.meta.syntactic.Tokens)(_rank: Int, _tree: Any): scala.meta.internal.ast.Term.If.Quasi.Impl = {
        Impl.super.<init>();
        ()
      };
      def parent: Option[scala.meta.Tree] = if (Impl.this.privateParent.!=(null))
