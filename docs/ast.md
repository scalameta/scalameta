...
@org.scalameta.ast.internal.astClass @org.scalameta.adt.Internal.leafClass final class If extends AnyRef with scala.meta.Term with Product {
    ...
    (if (this._cond.==(null))
      {
        ...
        this._cond_=({
          ...
          qual$19.internalCopy(x$99, x$100, x$101)
        })
      }
    else
      (): Unit);
    ...
    (if (this._thenp.==(null))
      {
        ...
        this._thenp_=({
          ...
          <artifact> val x$102: scala.meta.Term = this.internalPrototype.thenp;
          <artifact> val x$103: scala.meta.Term.If = this;
          <artifact> val x$104: Map[scala.meta.semantic.Host,scala.collection.immutable.Seq[Any]] = qual$20.internalCopy$default$3;
          qual$20.internalCopy(x$102, x$103, x$104)
        })
      }
    else
      (): Unit);
    ...
    (if (this._elsep.==(null))
      {
        ...
        this._elsep_=({
          ...
          <artifact> val x$105: scala.meta.Term = this.internalPrototype.elsep;
          <artifact> val x$106: scala.meta.Term.If = this;
          <artifact> val x$107: Map[scala.meta.semantic.Host,scala.collection.immutable.Seq[Any]] = qual$21.internalCopy$default$3;
          qual$21.internalCopy(x$105, x$106, x$107)
        })
      }
    else
      (): Unit);
  ...
  def copy(cond: scala.meta.Term = this.cond, thenp: scala.meta.Term = this.thenp, elsep: scala.meta.Term = this.elsep): If.this.ThisType = Term.this.If.apply(cond, thenp, elsep);
...
@@<?> @@<?> object If extends scala.AnyRef {
  ...
  def apply(cond: scala.meta.Term, thenp: scala.meta.Term, elsep: scala.meta.Term = null): scala.meta.Term.If = {
    def internal(cond: scala.meta.Term, thenp: scala.meta.Term, elsep: scala.meta.Term, @org.scalameta.ast.trivia @org.scalameta.ast.auto hasElsep: Boolean): scala.meta.Term.If = {
      ...
      <empty>;
      <empty>;
      val node: scala.meta.Term.If = new Term.this.If(null, null, scala.collection.immutable.Map.apply[scala.meta.semantic.Host, Nothing]())((null: scala.meta.Term), (null: scala.meta.Term), (null: scala.meta.Term), (hasElsep: Boolean));
