...
@new _root_.org.scalameta.ast.internal.astClass() @new _root_.org.scalameta.adt.Internal.leafClass() abstract trait If extends Term with _root_.scala.Product {
  ...
  @new _root_.org.scalameta.ast.internal.astField() @new _root_.org.scalameta.ast.internal.auxiliary() def status: _root_.scala.meta.internal.semantic.Status;
...
@new _root_.org.scalameta.ast.internal.astCompanion() @new _root_.org.scalameta.adt.Internal.leafCompanion() object If extends scala.AnyRef {
  ...
  def apply(cond: Term, thenp: Term, elsep: Term, @new _root_.org.scalameta.ast.internal.auxiliary() status: _root_.scala.meta.internal.semantic.Status = _root_.scala.meta.internal.semantic.Status.Unknown, @new _root_.org.scalameta.ast.internal.auxiliary() expansion: _root_.scala.meta.internal.semantic.Expansion = _root_.scala.meta.internal.semantic.Expansion.Identity, tokens: _root_.scala.meta.Tokens = null): If = {
    def internal(cond: Term, thenp: Term, elsep: Term, @new _root_.org.scalameta.ast.internal.auxiliary() status: _root_.scala.meta.internal.semantic.Status, @new _root_.org.scalameta.ast.internal.auxiliary() expansion: _root_.scala.meta.internal.semantic.Expansion, tokens: _root_.scala.meta.Tokens): If = {
      ...
      _root_.org.scalameta.adt.Internal.nullCheck(status);
      ...
      _root_.org.scalameta.adt.Internal.emptyCheck(status);
      _root_.org.scalameta.adt.Internal.emptyCheck(expansion);
      val node = new Impl(null, null, tokens)(_root_.org.scalameta.ast.internal.initParam(cond), _root_.org.scalameta.ast.internal.initParam(thenp), _root_.org.scalameta.ast.internal.initParam(elsep), _root_.org.scalameta.ast.internal.initParam(status), _root_.org.scalameta.ast.internal.initParam(expansion));
      ...
      _root_.org.scalameta.ast.internal.storeField(node._status, status);
      _root_.org.scalameta.ast.internal.storeField(node._expansion, expansion);
      node
    };
    internal(cond, thenp, elsep, status, expansion, tokens)
  };
  ...
  abstract trait Api extends If {
    ...
    def copy(cond: Term = this.cond, thenp: Term = this.thenp, elsep: Term = this.elsep, status: _root_.scala.meta.internal.semantic.Status = _root_.scala.meta.internal.semantic.Status.Unknown, expansion: _root_.scala.meta.internal.semantic.Expansion = _root_.scala.meta.internal.semantic.Expansion.Identity, tokens: _root_.scala.meta.Tokens = _root_.scala.meta.Tokens.Prototype(this)): ThisType = If.apply(cond, thenp, elsep, status, expansion, tokens);
    override type ThisType = If;
  ...
  final private[If] class Impl extends Api {
    ...
    @new _root_.org.scalameta.ast.internal.auxiliary() <paramaccessor> var _status: _root_.scala.meta.internal.semantic.Status = _;
    ...
    def status: _root_.scala.meta.internal.semantic.Status = {
      _root_.org.scalameta.ast.internal.loadField(this._status);
      this._status
    };
  ...
  @new _root_.org.scalameta.ast.ast() private[meta] class Quasi extends If with _root_.scala.meta.internal.ast.Quasi with Term.Quasi {
    ...
    override def elsep: _root_.scala.Nothing = throw new _root_.scala.`package`.UnsupportedOperationException(if (this.rank.$eq$eq(0))
      ...
      "unsupported splicing position");
    override def status: _root_.scala.Nothing = throw new _root_.scala.`package`.UnsupportedOperationException(if (this.rank.$eq$eq(0))
      "unsupported unquoting position"
    else
      "unsupported splicing position");
...
@org.scalameta.ast.internal.astClass @org.scalameta.adt.Internal.leafClass abstract trait If extends AnyRef with scala.meta.internal.ast.Term with Product {
  ...
  @org.scalameta.ast.internal.astField @org.scalameta.ast.internal.auxiliary def status: scala.meta.internal.semantic.Status;
...
@@<?> @@<?> object If extends scala.AnyRef {
  ...
  def apply(cond: scala.meta.internal.ast.Term, thenp: scala.meta.internal.ast.Term, elsep: scala.meta.internal.ast.Term, @org.scalameta.ast.internal.auxiliary status: scala.meta.internal.semantic.Status = scala.meta.internal.semantic.Status.Unknown, @org.scalameta.ast.internal.auxiliary expansion: scala.meta.internal.semantic.Expansion = scala.meta.internal.semantic.Expansion.Identity, tokens: meta.Tokens = null): scala.meta.internal.ast.Term.If = {
    def internal(cond: scala.meta.internal.ast.Term, thenp: scala.meta.internal.ast.Term, elsep: scala.meta.internal.ast.Term, @org.scalameta.ast.internal.auxiliary status: scala.meta.internal.semantic.Status, @org.scalameta.ast.internal.auxiliary expansion: scala.meta.internal.semantic.Expansion, tokens: meta.Tokens): scala.meta.internal.ast.Term.If = {
      ...
      ({
        ...
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(false, (failures$macro$361 @ _)) => org.scalameta.invariants.InvariantFailedException.raise("cond.!=(null)", failures$macro$361, scala.collection.immutable.Map.apply[String, scala.meta.internal.ast.Term](scala.Tuple2.apply[String, scala.meta.internal.ast.Term]("cond", cond)))
      }: Unit);
      ({
        val result$macro$364: Boolean = thenp.!=(null);
        if (result$macro$364)
          scala.Tuple2.apply[Boolean, collection.immutable.Nil.type](true, scala.collection.immutable.Nil)
        else
      ...
      ({
        ...
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(true, _) => ()
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(false, (failures$macro$365 @ _)) => org.scalameta.invariants.InvariantFailedException.raise("elsep.!=(null)", failures$macro$365, scala.collection.immutable.Map.apply[String, scala.meta.internal.ast.Term](scala.Tuple2.apply[String, scala.meta.internal.ast.Term]("elsep", elsep)))
      }: Unit);
      ({
        val result$macro$368: Boolean = status.!=(null);
        if (result$macro$368)
          scala.Tuple2.apply[Boolean, collection.immutable.Nil.type](true, scala.collection.immutable.Nil)
        else
          scala.Tuple2.apply[Boolean, List[String]](false, scala.collection.immutable.List.apply[String]("status is equal to null"))
      } match {
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(true, _) => ()
        case (_1: Boolean, _2: List[String])(Boolean, List[String])(false, (failures$macro$367 @ _)) => org.scalameta.invariants.InvariantFailedException.raise("status.!=(null)", failures$macro$367, scala.collection.immutable.Map.apply[String, scala.meta.internal.semantic.Status](scala.Tuple2.apply[String, scala.meta.internal.semantic.Status]("status", status)))
      }: Unit);
      ({
        val result$macro$370: Boolean = expansion.!=(null);
        if (result$macro$370)
          scala.Tuple2.apply[Boolean, collection.immutable.Nil.type](true, scala.collection.immutable.Nil)
        else
      ...
      ();
      ();
      val node: scala.meta.internal.ast.Term.If.Impl = new If.this.Impl(null, null, tokens)((null: scala.meta.internal.ast.Term), (null: scala.meta.internal.ast.Term), (null: scala.meta.internal.ast.Term), (status: scala.meta.internal.semantic.Status), (expansion: scala.meta.internal.semantic.Expansion));
  ...
  <synthetic> def apply$default$4: scala.meta.internal.semantic.Status = scala.meta.internal.semantic.Status.Unknown;
  ...
  abstract trait Api extends AnyRef with scala.meta.internal.ast.Term.If {
    ...
    def copy(cond: scala.meta.internal.ast.Term = this.cond, thenp: scala.meta.internal.ast.Term = this.thenp, elsep: scala.meta.internal.ast.Term = this.elsep, status: scala.meta.internal.semantic.Status = scala.meta.internal.semantic.Status.Unknown, expansion: scala.meta.internal.semantic.Expansion = scala.meta.internal.semantic.Expansion.Identity, tokens: meta.Tokens = scala.meta.`package`.Tokens.Prototype.apply(this)): Api.this.ThisType = Term.this.If.apply(cond, thenp, elsep, status, expansion, tokens);
    ...
    <synthetic> def copy$default$4: scala.meta.internal.semantic.Status = scala.meta.internal.semantic.Status.Unknown;
  ...
  final private[If] class Impl extends AnyRef with scala.meta.internal.ast.Term.If.Api {
    ...
    <paramaccessor> private[this] var _status: scala.meta.internal.semantic.Status = _;
    @org.scalameta.ast.internal.auxiliary <accessor> <paramaccessor> def _status: scala.meta.internal.semantic.Status = Impl.this._status;
    <accessor> <paramaccessor> def _status_=(x$1: scala.meta.internal.semantic.Status): Unit = Impl.this._status = x$1;
    ...
    def status: scala.meta.internal.semantic.Status = {
      ((): Unit);
      this._status
    };
  ...
  @@<?> @@<?> private[meta] object Quasi extends scala.AnyRef {
    ...
    abstract trait Api extends AnyRef with scala.meta.internal.ast.Term.If.Quasi {
      ...
      override def elsep: Nothing = throw new scala.`package`.UnsupportedOperationException(if (this.rank.==(0))
        ...
        "unsupported splicing position");
      override def status: Nothing = throw new scala.`package`.UnsupportedOperationException(if (this.rank.==(0))
        "unsupported unquoting position"
      else
        "unsupported splicing position");
