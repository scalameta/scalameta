...
@new _root_.org.scalameta.ast.internal.astCompanion() @new _root_.org.scalameta.adt.Internal.leafCompanion() object If extends scala.AnyRef {
  ...
  abstract trait Api extends If {
    ...
    def withEnv(env: _root_.scala.meta.semantic.Environment): If = this.internalCopy(env = env, flags = this.internalFlags.$amp(_root_.scala.meta.internal.flags.`package`.TYPECHECKED.unary_$tilde));
