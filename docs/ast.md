...
@_root_.org.scalareflect.adt.Internal.leaf final class Name private (
  ...
  private val scratchpads: _root_.scala.collection.immutable.Map[_root_.scala.reflect.semantic.HostContext, _root_.scala.List[Any]],
  ...
  private[reflect] def scratchpad(implicit h: _root_.scala.reflect.semantic.HostContext): _root_.scala.List[Any] = scratchpads.getOrElse(h, Nil);
  private[reflect] def appendScratchpad(datum: Any)(implicit h: HostContext): ThisType = new ThisType(this, internalParent, scratchpads.+(h.->(scratchpads.getOrElse(h, Nil).:+(datum))), origin)(_root_.org.scalareflect.annotations.internal.ast.initField(this._value))(_root_.org.scalareflect.annotations.internal.ast.initField(this._isBackquoted));
  private[reflect] def withScratchpad(scratchpad: _root_.scala.List[Any])(implicit h: _root_.scala.reflect.semantic.HostContext): ThisType = new ThisType(this, internalParent, scratchpads.+(h.->(scratchpad)), origin)(_root_.org.scalareflect.annotations.internal.ast.initField(this._value))(_root_.org.scalareflect.annotations.internal.ast.initField(this._isBackquoted));
  private[reflect] def mapScratchpad(f: _root_.scala.Function1[_root_.scala.List[Any], _root_.scala.List[Any]])(implicit h: _root_.scala.reflect.semantic.HostContext): ThisType = new ThisType(this, internalParent, scratchpads.+(h.->(f(scratchpads.getOrElse(h, Nil)))), origin)(_root_.org.scalareflect.annotations.internal.ast.initField(this._value))(_root_.org.scalareflect.annotations.internal.ast.initField(this._isBackquoted));
...
@org.scalareflect.adt.Internal.leaf final class Name extends AnyRef with scala.reflect.core.Name with scala.reflect.core.Type.Ref with Product {
  ...
  <paramaccessor> private[this] val scratchpads: scala.collection.immutable.Map[scala.reflect.semantic.HostContext,List[Any]] = _;
  <stable> <accessor> <paramaccessor> private def scratchpads: scala.collection.immutable.Map[scala.reflect.semantic.HostContext,List[Any]] = Name.this.scratchpads;
  ...
  private[reflect] def scratchpad(implicit h: scala.reflect.semantic.HostContext): List[Any] = Name.this.scratchpads.getOrElse[List[Any]](h, immutable.this.Nil);
  private[reflect] def appendScratchpad(datum: Any)(implicit h: scala.reflect.semantic.HostContext): Name.this.ThisType = new Name.this.ThisType(this, Name.this.internalParent, Name.this.scratchpads.+[List[Any]](scala.this.Predef.ArrowAssoc[scala.reflect.semantic.HostContext](h).->[List[Any]](Name.this.scratchpads.getOrElse[List[Any]](h, immutable.this.Nil).:+[Any, List[Any]](datum)(immutable.this.List.canBuildFrom[Any]))), Name.this.origin)((this._value: String))((this._isBackquoted: Boolean));
  private[reflect] def withScratchpad(scratchpad: List[Any])(implicit h: scala.reflect.semantic.HostContext): Name.this.ThisType = new Name.this.ThisType(this, Name.this.internalParent, Name.this.scratchpads.+[List[Any]](scala.this.Predef.ArrowAssoc[scala.reflect.semantic.HostContext](h).->[List[Any]](scratchpad)), Name.this.origin)((this._value: String))((this._isBackquoted: Boolean));
  private[reflect] def mapScratchpad(f: List[Any] => List[Any])(implicit h: scala.reflect.semantic.HostContext): Name.this.ThisType = new Name.this.ThisType(this, Name.this.internalParent, Name.this.scratchpads.+[List[Any]](scala.this.Predef.ArrowAssoc[scala.reflect.semantic.HostContext](h).->[List[Any]](f.apply(Name.this.scratchpads.getOrElse[List[Any]](h, immutable.this.Nil)))), Name.this.origin)((this._value: String))((this._isBackquoted: Boolean));
