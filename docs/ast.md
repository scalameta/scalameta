...
@@<?> @@<?> object If extends scala.AnyRef {
  ...
  abstract trait Api extends AnyRef with scala.meta.internal.ast.Term.If {
    ...
    <synthetic> def copy$default$6: meta.Tokens = scala.meta.internal.ui.PrototypeTokens.apply(this);
    override type ThisType = scala.meta.internal.ast.Term.If;
  ...
  final private[If] class Impl extends AnyRef with scala.meta.internal.ast.Term.If.Api {
    ...
    def tokens: meta.Tokens = {
      Impl.this.internalTokens_=(Impl.this.internalTokens match {
        ...
        case (underlying: scala.meta.Tree)meta.internal.ui.PrototypeTokens((proto @ _)) => scala.meta.internal.ui.inferTokens.apply(this, scala.Some.apply[scala.meta.Tree](proto))
        case (other @ _) => other
      });
  ...
  @@<?> @@<?> private[meta] object Quasi extends scala.AnyRef {
    ...
    abstract trait Api extends AnyRef with scala.meta.internal.ast.Term.If.Quasi {
      ...
      def copy(tree: Any = this.tree, rank: Int = this.rank, tokens: meta.Tokens = scala.meta.internal.ui.PrototypeTokens.apply(this)): Api.this.ThisType = If.this.Quasi.apply(tree, rank, tokens);
      <synthetic> def copy$default$1: Any = this.tree;
      <synthetic> def copy$default$2: Int = this.rank;
      <synthetic> def copy$default$3: meta.Tokens = scala.meta.internal.ui.PrototypeTokens.apply(this);
      override type ThisType = scala.meta.internal.ast.Term.If.Quasi;
