...
| `def superclasses(member: Has.Template): Seq[Has.Template]` | All superclasses of a given class in linearization order.
| `def subclasses(member: Has.Template): Seq[Has.Template]`| All subclasses of a given class in the closed world reflected by the host.
