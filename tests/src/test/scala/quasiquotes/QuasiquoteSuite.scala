...
//  test("pt\"_\"") {
//    assert(pt"_".show[Structure] === "Pat.Wildcard()") // todo move to errors, this should be placeholder
//  }
//
//  test("pt\"name\"") {
//    assert(pt"name".show[Structure] === "Pat.Var.Type(Type.Name(\"name\"))")
//  }
//
//  test("pt\"x\"") {
//    assert(p"x".show[Structure] === "Pat.Var.Type(Type.Name(\"x\"))")
//  }
//
//  test("pt\"X\"") {
