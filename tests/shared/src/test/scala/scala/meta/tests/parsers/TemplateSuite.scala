...
class TemplateSuite extends ParseSuite {
  ...
  test("trait Inner <: { val x : Int = 3 }")(
    assertTree(templStat("trait Inner <: { val x : Int = 3 }"))(Trait(
      Nil,
      pname("Inner"),
      Nil,
      EmptyCtor(),
  ...
  test("trait A extends { val x: Int } with B")(
    assertTree(templStat("trait A extends { val x: Int = 2 } with B"))(Trait(
      Nil,
      pname("A"),
      Nil,
      EmptyCtor(),
  ...
  test("class A extends { val x: Int } with B")(
    assertTree(templStat("class A extends { val x: Int = 2 } with B"))(Class(
      Nil,
      pname("A"),
      Nil,
      EmptyCtor(),
  ...
  test("case class C(x: Int)(y: => Int)")(
    assertTree(templStat("case class C(x: Int)(y: => Int)"))(Class(
      Mod.Case() :: Nil,
      pname("C"),
      Nil,
