...
object CaseClasses1/*<=example.CaseClasses1.*/ {
  ...
  val cclass3/*<=example.CaseClasses1.cclass3.*/ = CClass/*=>example.CaseClasses1.CClass.*/(i/*=>example.CaseClasses1.CClass.apply().(i)*/ = 3, j/*=>example.CaseClasses1.CClass.apply().(j)*/ = "")
  val cclass4/*<=example.CaseClasses1.cclass4.*/ = CClass/*=>example.CaseClasses1.CClass.*/.apply/*=>example.CaseClasses1.CClass.apply().*/(i/*=>example.CaseClasses1.CClass.apply().(i)*/ = 4, j/*=>example.CaseClasses1.CClass.apply().(j)*/ = "")
}
...
object CaseClasses2/*<=example.CaseClasses2.*/ {
  ...
  val cclass3/*<=example.CaseClasses2.cclass3.*/ = CClass/*=>example.CaseClasses2.CClass.*/(j/*=>example.CaseClasses2.CClass.apply(+1).(j)*/ = "")
  val cclass4/*<=example.CaseClasses2.cclass4.*/ = CClass/*=>example.CaseClasses2.CClass.*/.apply/*=>example.CaseClasses2.CClass.apply(+1).*/(j/*=>example.CaseClasses2.CClass.apply(+1).(j)*/ = "")
