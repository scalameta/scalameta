...
object NamedApplyBlockCaseClassConstruction/*<=example.NamedApplyBlockCaseClassConstruction.*/ {
  ...
  val msg/*<=example.NamedApplyBlockCaseClassConstruction.msg.*/ = Msg/*=>example.NamedApplyBlockCaseClassConstruction.Msg.*/(bodyText/*=>example.NamedApplyBlockCaseClassConstruction.bodyText.*/, tail/*=>example.NamedApplyBlockCaseClassConstruction.Msg#tail.*/ = "tail")
}
