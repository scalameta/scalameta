...
class Methods/*<=example.Methods#*/[T/*<=example.Methods#[T]*/] {
  ...
  def m11/*<=example.Methods#m11().*/(x/*<=example.Methods#m11().(x)*/: Predef.type) = ???/*=>scala.Predef.`???`().*/
  ...
  def m19/*<=example.Methods#m19().*/(x/*<=example.Methods#m19().(x)*/: Int/*=>scala.Int#*/, y/*<=example.Methods#m19().(y)*/: Int/*=>scala.Int#*/ = 2)(z/*<=example.Methods#m19().(z)*/: Int/*=>scala.Int#*/ = 3) = ???/*=>scala.Predef.`???`().*/
}
