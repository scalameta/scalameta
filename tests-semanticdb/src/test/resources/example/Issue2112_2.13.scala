...
object Issue2112/*<=example.Issue2112.*/ {
  ...
  myNumber/*=>example.Issue2112.myNumber.*/ ::/*=>scala.collection.immutable.List#`::`().*/ 5 ::/*=>scala.collection.immutable.List#`::`().*/ Nil/*=>scala.package.Nil.*/
  ...
  def foo/*<=example.Issue2112.foo().*/(myNumber/*<=example.Issue2112.foo().(myNumber)*/: Int/*=>scala.Int#*/) = {
    ...
    myNumber/*=>example.Issue2112.foo().(myNumber)*/ ::/*=>scala.collection.immutable.List#`::`().*/ 5 ::/*=>scala.collection.immutable.List#`::`().*/ Nil/*=>scala.package.Nil.*/
  }
}
