...
trait ExprLifts(using override val internalQuotes: Quotes)(isPatternMode: Boolean) extends ReificationMacros with InternalTrait {
  ...
  def treeByMode[T](expr: Expr[T], args: Tree*): Tree =
  ...
  def liftTypeFuncParamClause(y: scala.meta.Type.FuncParamClause) = treeByMode('{scala.meta.Type.FuncParamClause}, term(y.values))
  def liftTypeBounds(y: scala.meta.Type.Bounds) = treeByMode('{scala.meta.Type.Bounds}, term(y.lo), term(y.hi))
  def liftMemberParamClauseGroup(y: scala.meta.Member.ParamClauseGroup) = treeByMode('{scala.meta.Member.ParamClauseGroup}, term(y.tparamClause), term(y.paramClauses))
  def liftTemplate(y: scala.meta.Template) = treeByMode('{scala.meta.Template.After_4_4_0}, term(y.early), term(y.inits), term(y.self), term(y.stats), term(y.`derives`))
  def liftImporter(y: scala.meta.Importer) = treeByMode('{scala.meta.Importer}, term(y.ref), term(y.importees))
  def liftSource(y: scala.meta.Source) = treeByMode('{scala.meta.Source}, term(y.stats))
  def liftMultiSource(y: scala.meta.MultiSource) = treeByMode('{scala.meta.MultiSource}, term(y.sources))
  def liftInit(y: scala.meta.Init) = treeByMode('{scala.meta.Init.After_4_6_0}, term(y.tpe), term(y.name), term(y.argClauses))
  def liftNameAnonymous(y: scala.meta.Name.Anonymous) = treeByMode('{scala.meta.Name.Anonymous})
  def liftNameThis(y: scala.meta.Name.This) = treeByMode('{scala.meta.Name.This})
  def liftNameIndeterminate(y: scala.meta.Name.Indeterminate) = treeByMode('{scala.meta.Name.Indeterminate}, term(y.value))
  def liftNamePlaceholder(y: scala.meta.Name.Placeholder) = treeByMode('{scala.meta.Name.Placeholder})
  def liftTermName(y: scala.meta.Term.Name) = treeByMode('{scala.meta.Term.Name}, term(y.value))
  def liftTermAnonymous(y: scala.meta.Term.Anonymous) = treeByMode('{scala.meta.Term.Anonymous})
  def liftTypeName(y: scala.meta.Type.Name) = treeByMode('{scala.meta.Type.Name}, term(y.value))
  def liftTermThis(y: scala.meta.Term.This) = treeByMode('{scala.meta.Term.This}, term(y.qual))
  def liftTermSuper(y: scala.meta.Term.Super) = treeByMode('{scala.meta.Term.Super}, term(y.thisp), term(y.superp))
  def liftTermSelect(y: scala.meta.Term.Select) = treeByMode('{scala.meta.Term.Select}, term(y.qual), term(y.name))
  def liftTermApplyUnary(y: scala.meta.Term.ApplyUnary) = treeByMode('{scala.meta.Term.ApplyUnary}, term(y.op), term(y.arg))
  def liftTypeSelect(y: scala.meta.Type.Select) = treeByMode('{scala.meta.Type.Select}, term(y.qual), term(y.name))
  def liftTypeProject(y: scala.meta.Type.Project) = treeByMode('{scala.meta.Type.Project}, term(y.qual), term(y.name))
  def liftTypeSingleton(y: scala.meta.Type.Singleton) = treeByMode('{scala.meta.Type.Singleton}, term(y.ref))
  def liftImporteeWildcard(y: scala.meta.Importee.Wildcard) = treeByMode('{scala.meta.Importee.Wildcard})
  def liftImporteeGiven(y: scala.meta.Importee.Given) = treeByMode('{scala.meta.Importee.Given}, term(y.tpe))
  def liftImporteeGivenAll(y: scala.meta.Importee.GivenAll) = treeByMode('{scala.meta.Importee.GivenAll})
  def liftImporteeName(y: scala.meta.Importee.Name) = treeByMode('{scala.meta.Importee.Name}, term(y.name))
  def liftImporteeRename(y: scala.meta.Importee.Rename) = treeByMode('{scala.meta.Importee.Rename}, term(y.name), term(y.rename))
  def liftImporteeUnimport(y: scala.meta.Importee.Unimport) = treeByMode('{scala.meta.Importee.Unimport}, term(y.name))
  def liftTypeAnonymousName(y: scala.meta.Type.AnonymousName) = treeByMode('{scala.meta.Type.AnonymousName})
  def liftTypeApply(y: scala.meta.Type.Apply) = treeByMode('{scala.meta.Type.Apply.After_4_6_0}, term(y.tpe), term(y.argClause))
  def liftTypeApplyInfix(y: scala.meta.Type.ApplyInfix) = treeByMode('{scala.meta.Type.ApplyInfix.Initial}, term(y.lhs), term(y.op), term(y.rhs))
  def liftTypePolyFunction(y: scala.meta.Type.PolyFunction) = treeByMode('{scala.meta.Type.PolyFunction.After_4_6_0}, term(y.tparamClause), term(y.tpe))
  def liftTypeImplicitFunction(y: scala.meta.Type.ImplicitFunction) = treeByMode('{scala.meta.Type.ImplicitFunction.Initial}, term(y.params), term(y.res))
  def liftTypeTuple(y: scala.meta.Type.Tuple) = treeByMode('{scala.meta.Type.Tuple.Initial}, term(y.args))
  def liftTypeWith(y: scala.meta.Type.With) = treeByMode('{scala.meta.Type.With.Initial}, term(y.lhs), term(y.rhs))
  def liftTypeAnd(y: scala.meta.Type.And) = treeByMode('{scala.meta.Type.And.Initial}, term(y.lhs), term(y.rhs))
  def liftTypeOr(y: scala.meta.Type.Or) = treeByMode('{scala.meta.Type.Or.Initial}, term(y.lhs), term(y.rhs))
  def liftTypeRefine(y: scala.meta.Type.Refine) = treeByMode('{scala.meta.Type.Refine.Initial}, term(y.tpe), term(y.stats))
  def liftTypeExistential(y: scala.meta.Type.Existential) = treeByMode('{scala.meta.Type.Existential.Initial}, term(y.tpe), term(y.stats))
  def liftTypeAnnotate(y: scala.meta.Type.Annotate) = treeByMode('{scala.meta.Type.Annotate.Initial}, term(y.tpe), term(y.annots))
  def liftTypeLambda(y: scala.meta.Type.Lambda) = treeByMode('{scala.meta.Type.Lambda.After_4_6_0}, term(y.tparamClause), term(y.tpe))
  def liftTypeAnonymousLambda(y: scala.meta.Type.AnonymousLambda) = treeByMode('{scala.meta.Type.AnonymousLambda.Initial}, term(y.tpe))
  def liftTypeMacro(y: scala.meta.Type.Macro) = treeByMode('{scala.meta.Type.Macro.Initial}, term(y.body))
  def liftTypeMethod(y: scala.meta.Type.Method) = treeByMode('{scala.meta.Type.Method.After_4_6_0}, term(y.paramClauses), term(y.tpe))
  def liftTypePatWildcard(y: scala.meta.Type.PatWildcard) = treeByMode('{scala.meta.Type.PatWildcard})
  def liftTypeByName(y: scala.meta.Type.ByName) = treeByMode('{scala.meta.Type.ByName.Initial}, term(y.tpe))
  def liftTypeRepeated(y: scala.meta.Type.Repeated) = treeByMode('{scala.meta.Type.Repeated.Initial}, term(y.tpe))
  def liftTypeVar(y: scala.meta.Type.Var) = treeByMode('{scala.meta.Type.Var.Initial}, term(y.name))
  def liftTypeMatch(y: scala.meta.Type.Match) = treeByMode('{scala.meta.Type.Match.Initial}, term(y.tpe), term(y.cases))
  def liftLitNull(y: scala.meta.Lit.Null) = treeByMode('{scala.meta.Lit.Null})
  def liftLitInt(y: scala.meta.Lit.Int) = treeByMode('{scala.meta.Lit.Int.Initial}, term(y.value))
  def liftLitDouble(y: scala.meta.Lit.Double) = treeByMode('{scala.meta.Lit.Double.Initial}, term(y.format))
  def liftLitFloat(y: scala.meta.Lit.Float) = treeByMode('{scala.meta.Lit.Float.Initial}, term(y.format))
  def liftLitByte(y: scala.meta.Lit.Byte) = treeByMode('{scala.meta.Lit.Byte.Initial}, term(y.value))
  def liftLitShort(y: scala.meta.Lit.Short) = treeByMode('{scala.meta.Lit.Short.Initial}, term(y.value))
  def liftLitChar(y: scala.meta.Lit.Char) = treeByMode('{scala.meta.Lit.Char.Initial}, term(y.value))
  def liftLitLong(y: scala.meta.Lit.Long) = treeByMode('{scala.meta.Lit.Long.Initial}, term(y.value))
  def liftLitBoolean(y: scala.meta.Lit.Boolean) = treeByMode('{scala.meta.Lit.Boolean.Initial}, term(y.value))
  def liftLitUnit(y: scala.meta.Lit.Unit) = treeByMode('{scala.meta.Lit.Unit})
  def liftLitString(y: scala.meta.Lit.String) = treeByMode('{scala.meta.Lit.String.Initial}, term(y.value))
  // def liftLitSymbol(y: scala.meta.Lit.Symbol) = treeByMode('{scala.meta.Lit.Symbol}, term(y.value))
  def liftTypeFunction(y: scala.meta.Type.Function) = treeByMode('{scala.meta.Type.Function.After_4_6_0}, term(y.paramClause), term(y.res))
  def liftTypeContextFunction(y: scala.meta.Type.ContextFunction) = treeByMode('{scala.meta.Type.ContextFunction.After_4_6_0}, term(y.paramClause), term(y.res))
  def liftTypePlaceholderImpl(y: scala.meta.Type.Placeholder.Impl) = treeByMode('{scala.meta.Type.Placeholder.Impl.Initial}, term(y.bounds))
  def liftTypeWildcard(y: scala.meta.Type.Wildcard) = treeByMode('{scala.meta.Type.Wildcard.Initial}, term(y.bounds))
  def liftTypeAnonymousParam(y: scala.meta.Type.AnonymousParam) = treeByMode('{scala.meta.Type.AnonymousParam.Initial}, term(y.variant))
  def liftTypeTypedParam(y: scala.meta.Type.TypedParam) = treeByMode('{scala.meta.Type.TypedParam.After_4_7_8}, term(y.name), term(y.typ), term(y.mods))
  def liftTypeFunctionArg(y: scala.meta.Type.FunctionArg) = treeByMode('{scala.meta.Type.FunctionArg.Initial}, term(y.mods), term(y.tpe))
  def liftPatVar(y: scala.meta.Pat.Var) = treeByMode('{scala.meta.Pat.Var.Initial}, term(y.name))
  def liftPatWildcard(y: scala.meta.Pat.Wildcard) = treeByMode('{scala.meta.Pat.Wildcard})
  def liftPatSeqWildcard(y: scala.meta.Pat.SeqWildcard) = treeByMode('{scala.meta.Pat.SeqWildcard})
  def liftPatBind(y: scala.meta.Pat.Bind) = {
    ...
    treeByMode('{scala.meta.Pat.Bind}, term(y.lhs), term(y.rhs))
  }
  def liftPatAlternative(y: scala.meta.Pat.Alternative) = treeByMode('{scala.meta.Pat.Alternative.Initial}, term(y.lhs), term(y.rhs))
  def liftPatTuple(y: scala.meta.Pat.Tuple) = treeByMode('{scala.meta.Pat.Tuple.Initial}, term(y.args))
  def liftPatRepeated(y: scala.meta.Pat.Repeated) = treeByMode('{scala.meta.Pat.Repeated.Initial}, term(y.name))
  def liftPatExtract(y: scala.meta.Pat.Extract) = treeByMode('{scala.meta.Pat.Extract.After_4_6_0}, term(y.fun), term(y.argClause))
  def liftPatExtractInfix(y: scala.meta.Pat.ExtractInfix) = treeByMode('{scala.meta.Pat.ExtractInfix.After_4_6_0}, term(y.lhs), term(y.op), term(y.argClause))
  def liftPatInterpolate(y: scala.meta.Pat.Interpolate) = treeByMode('{scala.meta.Pat.Interpolate.Initial}, term(y.prefix), term(y.parts), term(y.args))
  def liftPatXml(y: scala.meta.Pat.Xml) = treeByMode('{scala.meta.Pat.Xml.Initial}, term(y.parts), term(y.args))
  def liftPatTyped(y: scala.meta.Pat.Typed) = {
    ...
    treeByMode('{scala.meta.Pat.Typed}, term(y.lhs), term(y.rhs))
  }
  def liftPatMacro(y: scala.meta.Pat.Macro) = treeByMode('{scala.meta.Pat.Macro.Initial}, term(y.body))
  def liftPatGiven(y: scala.meta.Pat.Given) = treeByMode('{scala.meta.Pat.Given.Initial}, term(y.tpe))
  def liftPkg(y: scala.meta.Pkg) = treeByMode('{scala.meta.Pkg.Initial}, term(y.ref), term(y.stats))
  def liftPkgObject(y: scala.meta.Pkg.Object) = treeByMode('{scala.meta.Pkg.Object.Initial}, term(y.mods), term(y.name), term(y.templ))
  def liftCtorSecondary(y: scala.meta.Ctor.Secondary) = treeByMode('{scala.meta.Ctor.Secondary.After_4_6_0}, term(y.mods), term(y.name), term(y.paramClauses), term(y.init), term(y.stats))
  def liftTermInterpolate(y: scala.meta.Term.Interpolate) = treeByMode('{scala.meta.Term.Interpolate.Initial}, term(y.prefix), term(y.parts), term(y.args))
  def liftTermXml(y: scala.meta.Term.Xml) = treeByMode('{scala.meta.Term.Xml.Initial}, term(y.parts), term(y.args))
  def liftTermApply(y: scala.meta.Term.Apply) = {
    ...
    def applyTermQuasi(fn: scala.meta.Term)(arg: scala.meta.Term.Quasi) = {
      ...
      treeByMode('{scala.meta.internal.trees.Syntactic.TermApply.ArgListList}, term(fn), term(List(List(arg))))
    }
    def applyArgClauseQuasi(fn: _root_.scala.meta.Term)(arg: _root_.scala.meta.Term.ArgClause.Quasi) = {
      checkNoTripleDots(fn, arg)
      treeByMode('{scala.meta.internal.trees.Syntactic.TermApply.ArgList}, term(fn), term(List(arg)))
    }
    y match {
      case ApplyToTripleDots((fn @ _), (either @ _)) => either.fold(applyTermQuasi(fn), applyArgClauseQuasi(fn))
      case _ => treeByMode('{scala.meta.Term.Apply.After_4_6_0}, term(y.fun), term(y.argClause))
    }
  }
  def liftTermApplyUsing(y: scala.meta.Term.ApplyUsing) = treeByMode('{scala.meta.Term.ApplyUsing.After_4_6_0}, term(y.fun), term(y.argClause))
  def liftTermApplyType(y: scala.meta.Term.ApplyType) = treeByMode('{scala.meta.Term.ApplyType.After_4_6_0}, term(y.fun), term(y.targClause))
  def liftTermApplyInfix(y: scala.meta.Term.ApplyInfix) = treeByMode('{scala.meta.Term.ApplyInfix.After_4_6_0}, term(y.lhs), term(y.op), term(y.targClause), term(y.argClause))
  def liftTermAssign(y: scala.meta.Term.Assign) = treeByMode('{scala.meta.Term.Assign.Initial}, term(y.lhs), term(y.rhs))
  def liftTermReturn(y: scala.meta.Term.Return) = treeByMode('{scala.meta.Term.Return.Initial}, term(y.expr))
  def liftTermThrow(y: scala.meta.Term.Throw) = treeByMode('{scala.meta.Term.Throw.Initial}, term(y.expr))
  def liftTermAscribe(y: scala.meta.Term.Ascribe) = treeByMode('{scala.meta.Term.Ascribe.Initial}, term(y.expr), term(y.tpe))
  def liftTermAnnotate(y: scala.meta.Term.Annotate) = treeByMode('{scala.meta.Term.Annotate.Initial}, term(y.expr), term(y.annots))
  def liftTermTuple(y: scala.meta.Term.Tuple) = treeByMode('{scala.meta.Term.Tuple.Initial}, term(y.args))
  def liftTermBlock(y: scala.meta.Term.Block) = treeByMode('{scala.meta.Term.Block.Initial}, term(y.stats))
  def liftTermEndMarker(y: scala.meta.Term.EndMarker) = treeByMode('{scala.meta.Term.EndMarker.Initial}, term(y.name))
  def liftTermIf(y: scala.meta.Term.If) = treeByMode('{scala.meta.Term.If.After_4_4_0}, term(y.cond), term(y.thenp), term(y.elsep), term(y.mods))
  def liftTermQuotedMacroExpr(y: scala.meta.Term.QuotedMacroExpr) = treeByMode('{scala.meta.Term.QuotedMacroExpr.Initial}, term(y.body))
  def liftTermQuotedMacroType(y: scala.meta.Term.QuotedMacroType) = treeByMode('{scala.meta.Term.QuotedMacroType.Initial}, term(y.tpe))
  def liftTermSplicedMacroExpr(y: scala.meta.Term.SplicedMacroExpr) = treeByMode('{scala.meta.Term.SplicedMacroExpr.Initial}, term(y.body))
  def liftTermSplicedMacroPat(y: scala.meta.Term.SplicedMacroPat) = treeByMode('{scala.meta.Term.SplicedMacroPat.Initial}, term(y.pat))
  def liftTermMatch(y: scala.meta.Term.Match) = treeByMode('{scala.meta.Term.Match.After_4_4_5}, term(y.expr), term(y.cases), term(y.mods))
  def liftTermTry(y: scala.meta.Term.Try) = treeByMode('{scala.meta.Term.Try.Initial}, term(y.expr), term(y.catchp), term(y.finallyp))
  def liftTermTryWithHandler(y: scala.meta.Term.TryWithHandler) = treeByMode('{scala.meta.Term.TryWithHandler.Initial}, term(y.expr), term(y.catchp), term(y.finallyp))
  def liftTermAnonymousFunction(y: scala.meta.Term.AnonymousFunction) = treeByMode('{scala.meta.Term.AnonymousFunction.Initial}, term(y.body))
  def liftTermPolyFunction(y: scala.meta.Term.PolyFunction) = treeByMode('{scala.meta.Term.PolyFunction.After_4_6_0}, term(y.tparamClause), term(y.body))
  def liftTermPartialFunction(y: scala.meta.Term.PartialFunction) = treeByMode('{scala.meta.Term.PartialFunction.Initial}, term(y.cases))
  def liftTermWhile(y: scala.meta.Term.While) = treeByMode('{scala.meta.Term.While.Initial}, term(y.expr), term(y.body))
  def liftTermDo(y: scala.meta.Term.Do) = treeByMode('{scala.meta.Term.Do.Initial}, term(y.body), term(y.expr))
  def liftTermFor(y: scala.meta.Term.For) = treeByMode('{scala.meta.Term.For.Initial}, term(y.enums), term(y.body))
  def liftTermForYield(y: scala.meta.Term.ForYield) = treeByMode('{scala.meta.Term.ForYield.Initial}, term(y.enums), term(y.body))
  def liftTermNew(y: scala.meta.Term.New) = treeByMode('{scala.meta.Term.New.Initial}, term(y.init))
  def liftTermNewAnonymous(y: scala.meta.Term.NewAnonymous) = treeByMode('{scala.meta.Term.NewAnonymous.Initial}, term(y.templ))
  def liftTermPlaceholder(y: scala.meta.Term.Placeholder) = treeByMode('{scala.meta.Term.Placeholder})
  def liftTermEta(y: scala.meta.Term.Eta) = treeByMode('{scala.meta.Term.Eta.Initial}, term(y.expr))
  def liftTermRepeated(y: scala.meta.Term.Repeated) = treeByMode('{scala.meta.Term.Repeated.Initial}, term(y.expr))
  def liftTermContextFunction(y: scala.meta.Term.ContextFunction) = treeByMode('{scala.meta.Term.ContextFunction.After_4_6_0}, term(y.paramClause), term(y.body))
  def liftTermFunction(y: scala.meta.Term.Function) = treeByMode('{scala.meta.Term.Function.After_4_6_0}, term(y.paramClause), term(y.body))
  def liftDefnGiven(y: scala.meta.Defn.Given) = treeByMode('{scala.meta.Defn.Given.After_4_6_0}, term(y.mods), term(y.name), term(y.paramClauseGroup), term(y.templ))
  def liftDefnEnum(y: scala.meta.Defn.Enum) = treeByMode('{scala.meta.Defn.Enum.After_4_6_0}, term(y.mods), term(y.name), term(y.tparamClause), term(y.ctor), term(y.templ))
  def liftDefnClass(y: scala.meta.Defn.Class) = treeByMode('{scala.meta.Defn.Class.After_4_6_0}, term(y.mods), term(y.name), term(y.tparamClause), term(y.ctor), term(y.templ))
  def liftDefnTrait(y: scala.meta.Defn.Trait) = treeByMode('{scala.meta.Defn.Trait.After_4_6_0}, term(y.mods), term(y.name), term(y.tparamClause), term(y.ctor), term(y.templ))
  def liftDefnObject(y: scala.meta.Defn.Object) = treeByMode('{scala.meta.Defn.Object.Initial}, term(y.mods), term(y.name), term(y.templ))
  def liftDeclVal(y: scala.meta.Decl.Val) = treeByMode('{scala.meta.Decl.Val.Initial}, term(y.mods), term(y.pats), term(y.decltpe))
  def liftDeclVar(y: scala.meta.Decl.Var) = treeByMode('{scala.meta.Decl.Var.Initial}, term(y.mods), term(y.pats), term(y.decltpe))
  def liftDeclDef(y: scala.meta.Decl.Def) = treeByMode('{scala.meta.Decl.Def.After_4_7_3}, term(y.mods), term(y.name), term(y.paramClauseGroups), term(y.decltpe))
  def liftDeclType(y: scala.meta.Decl.Type) = treeByMode('{scala.meta.Decl.Type.After_4_6_0}, term(y.mods), term(y.name), term(y.tparamClause), term(y.bounds))
  def liftDeclGiven(y: scala.meta.Decl.Given) = treeByMode('{scala.meta.Decl.Given.After_4_6_0}, term(y.mods), term(y.name), term(y.paramClauseGroup), term(y.decltpe))
  def liftDefnVal(y: scala.meta.Defn.Val) = {
    ...
    treeByMode('{scala.meta.Defn.Val}, term(y.mods), term(y.pats), term(y.decltpe), term(y.rhs))
  }
  def liftDefnVar(y: scala.meta.Defn.Var) = {
    ...
    treeByMode('{scala.meta.Defn.Var.After_4_7_2}, term(y.mods), term(y.pats), term(y.decltpe), term(y.body))
  }
  def liftDefnEnumCase(y: scala.meta.Defn.EnumCase) = treeByMode('{scala.meta.Defn.EnumCase.After_4_6_0}, term(y.mods), term(y.name), term(y.tparamClause), term(y.ctor), term(y.inits))
  def liftDefnRepeatedEnumCase(y: scala.meta.Defn.RepeatedEnumCase) = treeByMode('{scala.meta.Defn.RepeatedEnumCase.Initial}, term(y.mods), term(y.cases))
  def liftDefnGivenAlias(y: scala.meta.Defn.GivenAlias) = treeByMode('{scala.meta.Defn.GivenAlias.After_4_6_0}, term(y.mods), term(y.name), term(y.paramClauseGroup), term(y.decltpe), term(y.body))
                                            // treeByMode('{scala.meta.Decl.Def.After_4_7_3}, term(y.mods), term(y.name), term(y.paramClauseGroups), term(y.decltpe))
  def liftDefnDef(y: scala.meta.Defn.Def) = treeByMode('{scala.meta.Defn.Def.After_4_7_3}, term(y.mods), term(y.name), term(y.paramClauseGroups), term(y.decltpe), term(y.body))
  def liftDefnMacro(y: scala.meta.Defn.Macro) = treeByMode('{scala.meta.Defn.Macro.After_4_7_3}, term(y.mods), term(y.name), term(y.paramClauseGroups), term(y.decltpe), term(y.body))
  def liftDefnType(y: scala.meta.Defn.Type) = treeByMode('{scala.meta.Defn.Type.After_4_6_0}, term(y.mods), term(y.name), term(y.tparamClause), term(y.body), term(y.bounds))
  def liftDefnExtensionGroup(y: scala.meta.Defn.ExtensionGroup) = treeByMode('{scala.meta.Defn.ExtensionGroup.After_4_6_0}, term(y.paramClauseGroup), term(y.body))
  def liftImport(y: scala.meta.Import) = treeByMode('{scala.meta.Import.Initial}, term(y.importers))
  def liftExport(y: scala.meta.Export) = treeByMode('{scala.meta.Export.Initial}, term(y.importers))
  def liftTermArgClause(y: scala.meta.Term.ArgClause) = treeByMode('{scala.meta.Term.ArgClause.Initial}, term(y.values), term(y.mod))
  def liftTypeArgClause(y: scala.meta.Type.ArgClause) = treeByMode('{scala.meta.Type.ArgClause.Initial}, term(y.values))
  def liftPatArgClause(y: scala.meta.Pat.ArgClause) = treeByMode('{scala.meta.Pat.ArgClause.Initial}, term(y.values))
  def liftTermParamClause(y: scala.meta.Term.ParamClause) = treeByMode('{scala.meta.Term.ParamClause.Initial}, term(y.values), term(y.mod))
  def liftTypeParamClause(y: scala.meta.Type.ParamClause) = treeByMode('{scala.meta.Type.ParamClause.Initial}, term(y.values))
  def liftEnumeratorGenerator(y: scala.meta.Enumerator.Generator) = treeByMode('{scala.meta.Enumerator.Generator.Initial}, term(y.pat), term(y.rhs))
  def liftEnumeratorCaseGenerator(y: scala.meta.Enumerator.CaseGenerator) = treeByMode('{scala.meta.Enumerator.CaseGenerator.Initial}, term(y.pat), term(y.rhs))
  def liftEnumeratorVal(y: scala.meta.Enumerator.Val) = treeByMode('{scala.meta.Enumerator.Val.Initial}, term(y.pat), term(y.rhs))
  def liftCase(y: scala.meta.Case) = treeByMode('{scala.meta.Case.Initial}, term(y.pat), term(y.cond), term(y.body))
  def liftTypeCase(y: scala.meta.TypeCase) = treeByMode('{scala.meta.TypeCase.Initial}, term(y.pat), term(y.body))
  def liftTypeParam(y: scala.meta.Type.Param) = treeByMode('{scala.meta.Type.Param.After_4_6_0}, term(y.mods), term(y.name), term(y.tparamClause), term(y.tbounds), term(y.vbounds), term(y.cbounds))
  def liftTermParam(y: scala.meta.Term.Param) = treeByMode('{scala.meta.Term.Param.Initial}, term(y.mods), term(y.name), term(y.decltpe), term(y.default))
  def liftSelf(y: scala.meta.Self) = treeByMode('{scala.meta.Self.Initial}, term(y.name), term(y.decltpe))
  def liftCtorPrimary(y: scala.meta.Ctor.Primary) = treeByMode('{scala.meta.Ctor.Primary.After_4_6_0}, term(y.mods), term(y.name), term(y.paramClauses))
  def liftModAnnot(y: scala.meta.Mod.Annot) = treeByMode('{scala.meta.Mod.Annot.Initial}, term(y.init))
  def liftModPrivate(y: scala.meta.Mod.Private) = treeByMode('{scala.meta.Mod.Private.Initial}, term(y.within))
  def liftModProtected(y: scala.meta.Mod.Protected) = treeByMode('{scala.meta.Mod.Protected.Initial}, term(y.within))
  def liftModFinal(y: scala.meta.Mod.Final) = treeByMode('{scala.meta.Mod.Final})
  def liftModSealed(y: scala.meta.Mod.Sealed) = treeByMode('{scala.meta.Mod.Sealed})
  def liftModOpen(y: scala.meta.Mod.Open) = treeByMode('{scala.meta.Mod.Open})
  def liftModSuper(y: scala.meta.Mod.Super) = treeByMode('{scala.meta.Mod.Super})
  def liftModOverride(y: scala.meta.Mod.Override) = treeByMode('{scala.meta.Mod.Override})
  def liftModCase(y: scala.meta.Mod.Case) = treeByMode('{scala.meta.Mod.Case})
  def liftModAbstract(y: scala.meta.Mod.Abstract) = treeByMode('{scala.meta.Mod.Abstract})
  def liftModLazy(y: scala.meta.Mod.Lazy) = treeByMode('{scala.meta.Mod.Lazy})
  def liftModValParam(y: scala.meta.Mod.ValParam) = treeByMode('{scala.meta.Mod.ValParam})
  def liftModVarParam(y: scala.meta.Mod.VarParam) = treeByMode('{scala.meta.Mod.VarParam})
  def liftModInfix(y: scala.meta.Mod.Infix) = treeByMode('{scala.meta.Mod.Infix})
  def liftModInline(y: scala.meta.Mod.Inline) = treeByMode('{scala.meta.Mod.Inline})
  def liftModOpaque(y: scala.meta.Mod.Opaque) = treeByMode('{scala.meta.Mod.Opaque})
  def liftModTransparent(y: scala.meta.Mod.Transparent) = treeByMode('{scala.meta.Mod.Transparent})
  def liftModErased(y: scala.meta.Mod.Erased) = treeByMode('{scala.meta.Mod.Erased})
  def liftModImplicit(y: scala.meta.Mod.Implicit) = treeByMode('{scala.meta.Mod.Implicit})
  def liftModUsing(y: scala.meta.Mod.Using) = treeByMode('{scala.meta.Mod.Using})
  def liftModCovariant(y: scala.meta.Mod.Covariant) = treeByMode('{scala.meta.Mod.Covariant})
  def liftModContravariant(y: scala.meta.Mod.Contravariant) = treeByMode('{scala.meta.Mod.Contravariant})
  def liftEnumeratorGuard(y: scala.meta.Enumerator.Guard) = treeByMode('{scala.meta.Enumerator.Guard.Initial}, term(y.cond))
